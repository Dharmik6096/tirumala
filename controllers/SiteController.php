...
//echo $union_str; exit;
        ...
        if (Yii::$app->request->post()) {
            ...
            $farmer_widget = json_encode(!empty(Yii::$app->request->post('Dashboard')['farmer_widgets_after']) ? Yii::$app->request->post('Dashboard')['farmer_widgets_after'] : '');
            $rmrd_widget = json_encode(!empty(Yii::$app->request->post('Dashboard')['rmrd_widgets_after']) ? Yii::$app->request->post('Dashboard')['rmrd_widgets_after'] : '');
            ...
            $dashboardUserWidgets->is_farmer_popup = $farmer_widget;
            $dashboardUserWidgets->is_rmrd_popup = $rmrd_widget;
...
// $dashboardUserWidgets = new TblDashboardUserWidgets();
        ...
        if (!empty($userWidgets)) {
            ...
            $userFarmer = json_decode($userWidgets->is_farmer_popup);
            $userRmrd = json_decode($userWidgets->is_rmrd_popup);
        }
...
// $dpu_data = $this->DPUDataCollection($model);
        ...
        'userFarmer' => $userFarmer, 'userRmrd' => $userRmrd]);
    }
