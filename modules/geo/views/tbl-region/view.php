...
$this->params['menu'][] = GhostHtml::a(Yii::t('app', '<i class="fas fa-user-circle"></i> Contact Details'), ['/geo/tbl-region/contact-details', 'id' => $model->region_code], ['class' => 'btn btn-danger btn-block']);
?>
