...
<div class="row">
    <div class="col-sm-2 mt10"><label class="label_heading">Village Code:</label> <?php echo $ids; ?></div>

    <div class="col-sm-2 mt10"><label class="label_heading">Village Name:</label> <?php echo $name; ?></div>
