...
$this->params['menu'][] = GhostHtml::a(Yii::t('app', '<i class="fas fa-user-circle"></i> Contact Details'), ['/geo/tbl-area/contact-details', 'id' => $model->area_code], ['class' => 'btn btn-danger btn-block']);
?>
