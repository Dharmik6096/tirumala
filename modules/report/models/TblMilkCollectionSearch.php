...
class TblMilkCollectionSearch extends TblMilkCollection
{
     ...
     * @inheritdoc
     */
    public $union_code,$min_date,$max_date,$total_shift,$total_qty, $avg_fat, $avg_snf, $amount, $shift, $union_name,$dcs_name, $total_dcs, $dcs_code_ex, $shift_per,$disctrict_name, $MinDate,$MaxDate,$Summary,$dtdate,$kg_fat,$kg_snf,$avg_rate,$vendor;
    public function rules()
    {
        return [
            [['union_code'], 'required','except' => 'union_count'],
            [['min_date','max_date'],'required'],
            [['dcs_code','max_date','shift','milk_type_code','vendor'], 'safe'],
        ];
    }
