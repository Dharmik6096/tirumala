...
/**
 * This is the model class for table "tbl_inbox_other".
 *
 ...
 */
class TblInboxOther extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_inbox_other';
    }
    ...
    public function rules() {
        return [
                [['uuid', 'json_text', 'sequence_no', 'data_post_status', 'posting_timestamp', 'sync_timestamp', 'error_timestamp', 'picked_datetime', 'received_time', 'sync_time', 'uuid', 'source_org_type', 'dest_org_type', 'table_name', 'originating_org_type', 'source_device_mac', 'sync_status', 'source_org_id', 'dest_org_id', 'message_type', 'operation', 'originating_org_id', 'error_log', 'version_no', 'device_id'], 'safe'],
                [['data_post_status'], 'default', 'value' => 0],
                [['received_time'], 'default', 'value' => date('Y-m-d H:i:s')],
        ];
    }
