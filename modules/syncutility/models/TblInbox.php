...
class TblInbox extends \yii\db\ActiveRecord {
    ...
    public function getData() {
        ...
        $query = $this->find()
                ...
                ->andWhere(['NOT IN','tbl_inbox.table_name', ['tbl_config_txn_result', 'tbl_milk_collectionasd', 'tbl_milk_collection_summaryasd', 'tbl_product_sale', 'tbl_product_sale_details', 'tbl_product_sale_transaction', 'tbl_product_sale_installment', 'tbl_product_sale_tax_calculated']])
                ->orderBy(['ISNULL(tbl_sync_priority.sequence_no,99)' => SORT_ASC, 'tbl_inbox.posting_timestamp' => SORT_ASC])
                ->limit(300);
