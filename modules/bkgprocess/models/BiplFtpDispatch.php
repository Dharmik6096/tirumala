...
/**
 * This is the model class for table "bipl_ftp_dispatch".
 *
 * @property integer $id
 ...
 */
class BiplFtpDispatch extends \app\models\ChildModel {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'bipl_ftp_dispatch';
    }
    ...
    public function rules() {
        return [
            ...
            [['cp_code', 'local_code', 'date', 'time', 'milk_type', 'quantity', 'fat', 'snf', 'shift'], 'required'],
