...
class TblTransporterSearch extends TblTransporter {
    ...
    public function search($params) {
        ...
        $query->andFilterWhere([
            ...
            'transporter_ty pe' => $this->transporter_type,
        ...
        $query->andFilterWhere(['like', 'transporter_code', $this->transporter_code])
                ...
                ->andFilterWhere(['like', 'agreement_from_date', ($this->agreement_from_date == '') ? '' : Yii::$app->formatter->asDate($this->agreement_from_date, 'php:Y-m-d')])
                ->andFilterWhere(['like', 'agreement_to_date', ($this->agreement_to_date == '') ? '' : Yii::$app->formatter->asDate($this->agreement_to_date, 'php:Y-m-d')]);
