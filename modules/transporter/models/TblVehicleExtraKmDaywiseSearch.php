...
class TblVehicleExtraKmDaywiseSearch extends TblVehicleExtraKmDaywise {
    ...
    public function rules() {
        return [
            ...
            [['vehicle_code', 'transporter_code', 'date', 'created_at', 'created_by', 'updated_at', 'updated_by', 'union_code', 'originating_org_code', 'originating_org_type', 'x_col1', 'x_col2', 'x_col3', 'x_col4', 'x_col5'], 'safe'],
            [['extra_kms'], 'number'],
        ];
    }
