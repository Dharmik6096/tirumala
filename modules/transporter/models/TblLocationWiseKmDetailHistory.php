...
/**
 * This is the model class for table "tbl_location_wise_km_detail_history".
 *
 * @property integer $id
 ...
 */
class TblLocationWiseKmDetailHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_location_wise_km_detail_history';
    }
    ...
    public function rules() {
        return [
            [['km_detail_code', 'is_active'], 'safe'],
            [['from_type', 'from_dest', 'to_type', 'to_dest', 'union_code', 'created_by', 'updated_by', 'operation_type', 'history_created_by'], 'safe'],
