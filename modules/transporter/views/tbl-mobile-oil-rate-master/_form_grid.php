...
$grid_option = [
    ...
    'actions' => [
        ...
        'edit' => function ($url, $model) {
            ...
            $options = ['data-name' => $model->mobile_oil_rate_master_code, 'data-val' => $model->mobile_oil_rate_master_code, 'data-bs-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Edit', 'class' => $class];
