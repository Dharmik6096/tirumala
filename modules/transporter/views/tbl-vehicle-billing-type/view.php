...
$this->title = Yii::$app->label->title('view', 'Fuel Rate');
$this->params['menu'][] = Yii::$app->controls->update($model->vehicle_billing_code);
?>
                ...
                [
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => $model->billingTypeCode->billing_type,
                            'valueColOptions' => ['style' => 'width:30%']
                        ],
                    ],
                ],
