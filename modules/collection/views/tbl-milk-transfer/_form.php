...
<div class="row">
    ...
    <div class="col-sm-2">
        <?= Yii::$app->dropdown->depend_dropdown('bmc', $model, $form, 'tblmilktransfer-union_code', 'form-group', Yii::t('app', 'Source'), 'source_code', $readonly); ?>
    </div>
    <div class="col-sm-2">
        <?= Html::hiddenInput('self_bmc', FALSE, ['id' => 'tblmilktransfer-self_bmc']); ?>
        <?= Yii::$app->dropdown->poured_bmc($model, $form, 'tblmilktransfer-source_code,tblmilktransfer-self_bmc', 'destination_code', Yii::t('app', 'Destination'), FALSE, '', '', $readonly); ?>
    </div>
