...
//                'action' => ['get-temp-data'],
    ...
    <div class="col-sm-2">
        <?= Yii::$app->dropdown->all_routes($model, $form, 'tblbmccollectiontransfersearch-from_plant_code,tblbmccollectiontransfersearch-from_mcc_plant_code', 'route_code', $model->getAttributeLabel('route_code')); ?>
    </div>
    <div class="col-sm-2">
