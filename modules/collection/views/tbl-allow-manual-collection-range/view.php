...
<div class="panel panel-default panel-grid panel-main">
    <div class="panel-body">
        ...
        <?php if (!empty($approval_detail)) { ?>
            <div class="col-md-12 padding_10_0 theme-box mt10">
                <div class="col-sm-12 col-md-12 padding_left_0 padding_right_0 margin-bottom-10 clearfix">
                    <h4 class="theme-box-heading"><?php echo Yii::t('app', 'Manual Collection Request Approval Detail') ?></h4>
                </div>
                <div class="form-grid">
                    <div class="col-sm-12">
        ...
        <div class="col-md-12 padding_10_0 theme-box mt10">
            <div class="col-sm-12 col-md-12 padding_left_0 padding_right_0 margin-bottom-10 clearfix">
                <h4 class="theme-box-heading"><?php echo Yii::t('app', 'Manual '. ucwords(str_replace('_', ' ', preg_replace('/^tbl_/', '', $model->table_name))) . ' Approval Detail') ?></h4>
            </div>
            <div class="form-grid">
                <div class="col-sm-12">
                    <table class="table table-bordered table-striped table-main table-language table-rate">
                        ...
                        <?php foreach ($tableApprovalList as $approval) { ?>
                            <tr>
                                <td><?= $approval->level; ?></td>
                                <td><?= $approval->approval_mode; ?></td>
                                <?php if ($model->originating_org_type == 'MOBILE') { ?>
