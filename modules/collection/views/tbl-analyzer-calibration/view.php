        ...
        <div class="table-responsive">
            ...
            $attributes = [
                [
                    'columns' => [
                        [
                            'attribute' => 'analyzer_calibration_code',
                            'label' => 'Code',
                ...
                [
                    'columns' => [
                        [
                            'attribute' => 'snf_offset',
                            'valueColOptions' => ['style' => 'width:30%']
                        ],
                        [
                            'attribute' => 'date_time_of_calibration',
                            'valueColOptions' => ['style' => 'width:30%'],
                            'value' => Yii::$app->controls->view_date($model->date_time_of_calibration)
                        ],
                    ],
                ],
                [
