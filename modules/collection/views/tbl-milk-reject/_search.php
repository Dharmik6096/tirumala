...
<div class="search-filter large-search">
    ...
    <div class="col-sm-2">
        <?= Yii::$app->dropdown->union_plant($model, $form, 'tblmilkrejectsearch-union_code', 'plant_code', Yii::t('app', 'PLANT')); ?>
    </div>
    <div class="col-sm-2">
        <?= Yii::$app->dropdown->plant_mcc($model, $form, 'tblmilkrejectsearch-plant_code', 'mcc_plant_code', Yii::t('app', 'MCC'), FALSE); ?>
    </div> 
    <div class="col-sm-2">
        <?= Yii::$app->dropdown->mcc_bmc($model, $form, 'tblmilkrejectsearch-mcc_plant_code', 'bmc_code', Yii::t('app', 'BMC'), TRUE); ?>
    </div>
    <div class="col-sm-1">
