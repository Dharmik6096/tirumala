...
<div class="row theme_border_left theme_border_right theme_border_bottom">
    ...
    <div class="" id="dcshide">
        ...
        <div class="col-sm-2">
            <?= Yii::$app->dropdown->customer_code($model, $form, 'tblmilkreject-bmc_code,tblmilkreject-customer_type,tblmilkreject-date_time_of_collection', 'customer_code', $model->getAttributeLabel('customer_code'), FALSE, FALSE, FALSE); ?>
        </div>
    </div>
    <div class="col-sm-2">
