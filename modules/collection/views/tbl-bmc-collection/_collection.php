            ...
            <div class="col-sm-10">
                <div class="QltyParamDiv inline_block">
                    ...
                    <div class="col-sm-2 rtpl_validate create_fields reset_field">
                        <?= Yii::$app->dropdown->activate_customer_code($model, $form, 'tblbmccollection-union_code,tblbmccollection-bmc_code,tblbmccollection-customer_type,tblbmccollection-date_time_of_collection', 'customer_code', $model->getAttributeLabel('customer_code'), FALSE, false, false); ?>
                    </div>
                    <div class="col-sm-2 rtpl_validate create_fields">
