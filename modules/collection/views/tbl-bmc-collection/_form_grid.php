...
$attribute = [
        ...
        ['attribute' => 'route_code', 'label' => (Yii::t('app', 'Route Name')), 'value' => function($model) {
            return !empty($model->route_code) ? Yii::$app->general->getforeignkey($model->routeCode, 'route_name') : (Yii::$app->general->getmultiforeignkey($model->dcsCode, ['routeMapping'], 'route_name') == 'N/A' ? Yii::$app->general->getforeignkey($model->routeCode, 'route_name') : Yii::$app->general->getmultiforeignkey($model->dcsCode, ['routeMapping'], 'route_name'));
        }, 'vAlign' => 'middle', 'filter' => false],
