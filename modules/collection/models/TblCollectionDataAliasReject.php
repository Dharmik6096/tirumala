...
class TblCollectionDataAliasReject extends \app\models\ChildModel {
    ...
    public function rules() {
        return [
            ...
            [['fat', 'snf', 'clr', 'water', 'qty', 'rtpl', 'amount', 'converted_qty', 'protein', 'density', 'lactose', 'incentive', 'deduction', 'total_amount', 'converted_can', 'temperature', 'old_qty', 'old_fat', 'old_snf', 'old_rtpl', 'old_clr', 'old_amount', 'is_sms_sent', 'old_customer_code'], 'safe'],
            [['date_time_of_collection', 'date_time_of_recieve', 'qlty_time', 'qty_time', 'date_time_of_testing', 'route_arrival_time', 'vehicle_in_time', 'vehicle_out_time', 'created_at', 'updated_at', 'antibiotic', 'can_no'], 'safe'],
        ];
    }
