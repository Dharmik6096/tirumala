...
/**
 * This is the model class for table "tbl_sample_milk_collection_history".
 *
 * @property integer $id
 ...
 */
class TblSampleMilkCollectionHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_sample_milk_collection_history';
    }
    ...
    public function rules() {
        return [
                [['source_of_milk', 'plant_code', 'mcc_plant_code', 'bmc_code', 'dcs_code', 'route_code', 'own_bmc_code', 'own_mcc_plant_code', 'device_lat', 'device_long', 'union_code', 'fat', 'snf', 'clr', 'water', 'protein', 'density', 'lactose', 'qty', 'converted_qty', 'rtpl', 'amount', 'date_time_of_collection', 'qlty_time', 'qty_time', 'created_at', 'updated_at', 'history_created_at', 'sample_milk_collection_code', 'shift_code', 'milk_type_code', 'milk_quality_type_code', 'qty_mode', 'converted_qty_mode', 'purchase_rate_code', 'qlty_auto', 'qty_auto', 'milk_analyser_type_code', 'ws_code', 'originating_type', 'version_no', 'history_created_by', 'remarks', 'x_col1', 'x_col2', 'x_col3', 'x_col4', 'x_col5', 'operation_type', 'created_by', 'updated_by', 'originating_org_code', 'originating_org_type'], 'safe'],
        ];
    }
