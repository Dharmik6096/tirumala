...
//            [['fat', 'snf', 'water', 'qty', 'rtpl', 'amount'], 'number'],
            ...
            [['adt_param', 'adt_value', 'dpu_rtpl', 'dpu_amount', 'dpu_incentive', 'dpu_deduction', 'dpu_total_amount', 'received_timestamp', 'is_rate_recalc', 'purchase_rate_code_old','antibiotic'], 'safe']
        ];
    }
