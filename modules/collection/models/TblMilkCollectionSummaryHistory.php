...
class TblMilkCollectionSummaryHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            [['milk_collection_summary_code', 'union_code', 'plant_code', 'mcc_plant_code', 'bmc_code', 'dcs_code', 'created_by', 'updated_by', 'originating_org_code', 'originating_org_type', 'x_col1', 'x_col2', 'x_col3', 'x_col4', 'x_col5', 'history_created_by', 'operation_type'], 'safe'],
