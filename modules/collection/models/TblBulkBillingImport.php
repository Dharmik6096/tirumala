...
class TblBulkBillingImport extends \yii\db\ActiveRecord {
    ...
    public $plant_name, $dcs_name, $membership_status, $vendor_code, $member_signature, $net_payable_amount;
    ...
    public function attributeLabels() {
        return [
            ...
            'tds_rate' => Yii::t('app', 'Tds Rate'),
            'milk_commitment' => Yii::t('app', 'Milk Commitment'),
            'qty_till_date' => Yii::t('app', 'Qty Till Date'),
            'bank_account_no' => Yii::t('app', 'Bank Account No'),
            'ifsc' => Yii::t('app', 'Ifsc'),
            'net_payable_own_account' => Yii::t('app', 'Net Payable Own Account'),
            'net_payable_joint_account' => Yii::t('app', 'Net Payable Joint Account'),
            'remarks' => Yii::t('app', 'Remarks'),
            'head_val_seq1' => Yii::t('app', 'Milk Amount'),
