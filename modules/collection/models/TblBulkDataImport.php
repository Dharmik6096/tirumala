...
class TblBulkDataImport extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['member_code', 'dcs_code'], 'required', 'on' => ['milk_collection', 'milk_collection_qlty']],
            [['customer_code', 'milk_quality_type_code', 'route_arrival_time'], 'required', 'on' => ['bmc_collection', 'bmc_collection_mapped']],
            ...
            ['shift_code', 'in', 'range' => ['M', 'E', 'm', 'e'], 'on' => ['bmc_collection', 'milk_collection', 'milk_collection_qlty', 'bmc_collection_mapped']],
            ['milk_type_code', 'in', 'range' => ['C', 'B', 'M', 'c', 'b', 'm'], 'on' => ['bmc_collection', 'milk_collection', 'milk_collection_qlty', 'bmc_collection_mapped']],
            ['milk_quality_type_code', 'in', 'range' => ['Good', 'Curd', 'Sour', 'Drain', 'good', 'curd', 'sour', 'drain'], 'on' => ['bmc_collection', 'milk_collection', 'milk_collection_qlty', 'bmc_collection_mapped']],
            [['route_arrival_time'], 'match', 'pattern' => '/^(0[0-9]|1[0-9]|2[0-3]|[0-9]):[0-5][0-9]$/'],
            [['date_time_of_collection'], 'date', 'format' => 'php:d.m.Y', 'message' => Yii::t('app/validation', 'Please enter date in valid format e.g. 01.12.2018'), 'on' => ['bmc_collection', 'milk_collection', 'milk_collection_qlty', 'bmc_collection_mapped']],
