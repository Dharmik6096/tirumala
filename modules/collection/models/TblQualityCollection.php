...
class TblQualityCollection extends \app\models\ChildModel {
    ...
    public function rules() {
        return [
                ...
                [['protein', 'density', 'lactose', 'adt_param', 'adt_value', 'received_timestamp', 'antibiotic'], 'safe'],
                [['uuid'], 'validateBmcCode'],
                [['bmc_code'], function ($attribute, $params) {
                    if (empty($this->getErrors())) {
                        Yii::$app->general->paymentCycleLock($this, 'date_time_of_collection', 'bmc_code', 'BMC', 'DCS', ['data_lock_bmc', 'billing_lock_bmc', 'sync_lock_bmc']);
                    }
