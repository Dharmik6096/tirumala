...
/**
 * This is the model class for table "tbl_provisional_milk_collection_history".
 *
 * @property integer $id
 * @property string $provisional_milk_collection_code
 ...
 */
class TblProvisionalMilkCollectionHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_provisional_milk_collection_history';
    }
