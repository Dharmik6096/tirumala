...
class TblCollectionDataAliasHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['date_time_of_collection', 'date_time_of_recieve', 'qlty_time', 'qty_time', 'date_time_of_testing', 'route_arrival_time', 'vehicle_in_time', 'vehicle_out_time', 'created_at', 'updated_at', 'history_created_at', 'own_bmc_code', 'antibiotic_sms_sent'], 'safe'],
        ];
    }
