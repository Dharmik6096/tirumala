...
/**
 * This is the model class for table "tbl_collection_data_alias_history".
 *
 * @property integer $id
 ...
 */
class TblCollectionDataAliasHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_collection_data_alias_history';
    }
    ...
    public function rules() {
        return [
                ...
                [['date_time_of_collection', 'date_time_of_recieve', 'qlty_time', 'qty_time', 'date_time_of_testing', 'route_arrival_time', 'vehicle_in_time', 'vehicle_out_time', 'created_at', 'updated_at', 'history_created_at', 'own_bmc_code', 'antibiotic_sms_sent', 'antibiotic', 'is_sms_sent', 'old_customer_code', 'can_no', 'old_route_code', 'old_antibiotic', 'is_antibiotic', 'scheme_rate', 'scheme_rate_code', 'actual_rate', 'converted_amount', 'approved_at', 'approved_by', 'approval_status', 'vehicle_code'], 'safe'],
        ];
    }
