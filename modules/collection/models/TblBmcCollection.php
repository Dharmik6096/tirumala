...
//                }, 'except' => ['androidsync']],
            ...
            [['mcc_plant_code', 'plant_code', 'union_code', 'customer_code', 'customer_type', 'bmc_code', 'bmc_silos_info_code'], 'required', 'on' => ['create', 'update']],
            [['customer_code', 'bmc_code', 'bmc_silos_info_code'], 'required', 'on' => ['importCsv']],
