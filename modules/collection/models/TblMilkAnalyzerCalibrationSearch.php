...
class TblMilkAnalyzerCalibrationSearch extends TblMilkAnalyzerCalibration
{
    ...
    {
        return [
            [['milk_analyzer_calibration_id', 'shift_code', 'milk_type_code', 'originating_type'], 'integer'],
            [['union_code', 'plant_code', 'mcc_plant_code', 'bmc_code', 'dcs_code', 'milk_analyser_type_code', 'date_time_of_collection', 'remarks', 'sync_status', 'sync_timestamp', 'created_at', 'created_by', 'updated_at', 'updated_by', 'originating_org_code', 'originating_org_type', 'x_col1', 'x_col2', 'x_col3', 'x_col4', 'x_col5'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'milk_analyzer_calibration_id' => $this->milk_analyzer_calibration_id,
            'date_time_of_collection' => $this->date_time_of_collection,
            'shift_code' => $this->shift_code,
            'manual_fat' => $this->manual_fat,
            'actual_fat' => $this->actual_fat,
            'manual_snf' => $this->manual_snf,
            'actual_snf' => $this->actual_snf,
        ...
        $query->andFilterWhere(['like', 'union_code', $this->union_code])
            ...
            ->andFilterWhere(['like', 'milk_analyser_type_code', $this->milk_analyser_type_code])
