...
class TblBmcCollectionHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['adt_param', 'adt_value', 'bmc_silos_info_code', 'received_timestamp', 'x_col1', 'x_col2', 'x_col3', 'x_col4', 'x_col5', 'is_rate_recalc', 'purchase_rate_code_old', 'antibiotic', 'tare_weight', 'gross_weight'], 'safe']
        ];
    }
