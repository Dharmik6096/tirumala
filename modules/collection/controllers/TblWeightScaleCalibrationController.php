...
class TblWeightScaleCalibrationController extends Controller
{
    ...
    /**
     * Displays a single TblWeightScaleCalibration model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TblWeightScaleCalibration model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new TblWeightScaleCalibration();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->weight_scale_calibration_id]);
        } else {
    ...
    /**
     * Updates an existing TblWeightScaleCalibration model.
    ...
    /**
     * Deletes an existing TblWeightScaleCalibration model.
