...
class TblMccShiftEndSummaryController extends Controller
{
    ...
    /**
     * Displays a single TblMccShiftEndSummary model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TblMccShiftEndSummary model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new TblMccShiftEndSummary();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->mcc_shift_end_summary_code]);
        } else {
    ...
    /**
     * Updates an existing TblMccShiftEndSummary model.
    ...
    /**
     * Deletes an existing TblMccShiftEndSummary model.
