...
/**
 * TblMRGMeetingFeedbackSearch represents the model behind the search form about `app\modules\feedback\models\TblMRGMeetingFeedback`.
 */
class TblMRGMeetingFeedbackSearch extends TblMRGMeetingFeedback
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['MRG_M_feedback_id', 'MRG_M_Id', 'originating_type'], 'integer'],
    ...
    {
        $query = TblMRGMeetingFeedback::find();
