 ...
 */
class TblNonMemberHouseHoldVisitHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_non_member_house_hold_visit_history';
    }
