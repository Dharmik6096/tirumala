 ...
 */
class TblMRGMeetingFeedback extends ChildModel {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_MRG_meeting_feedback';
    }
    ...
    public function rules() {
        return [
            [['MRG_M_Id', 'month', 'feedback_desc', 'member_code', 'type', 'status', 'action_taken', 'remarks', 'created_at', 'created_by', 'updated_at', 'updated_by', 'originating_org_code', 'flg_sentbox_entry', 'originating_type'], 'safe'],
        ];
    }
