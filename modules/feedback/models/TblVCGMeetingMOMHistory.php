...
/**
 * This is the model class for table "tbl_VCG_meeting_MOM_history".
 *
 ...
 */
class TblVCGMeetingMOMHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_VCG_meeting_MOM_history';
    }
    ...
    public function rules() {
        return [
            [['VCG_MOM_id', 'VCG_M_Id', 'month', 'concern', 'member_code', 'mom_type_id', 'discussions', 'status', 'remarks_actions', 'process_type', 'created_at', 'created_by', 'updated_at', 'updated_by', 'originating_org_code', 'flg_sentbox_entry', 'originating_type', 'history_created_at', 'history_created_by'], 'safe'],
        ];
    }
