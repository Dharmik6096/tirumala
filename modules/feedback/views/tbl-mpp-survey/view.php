    ...
    <div class="row">
        <div class="col-md-12 view-subtitle padding_10_0 theme-box ">
            <div class="col-sm-12 col-md-12 padding_left_0 padding_right_0 clearfix">
                <h4 class="theme-box-heading accordion collapsed" data-toggle="collapse" data-target="#competitor_grid" aria-expanded="true" aria-controls="competitor_grid">
                    Competitors
                </h4>
            </div>
            <div class="col-sm-12 collapse" id="competitor_grid">
                <?=
        ...
        <div class="col-md-12 view-subtitle padding_10_0 theme-box ">
            <div class="col-sm-12 col-md-12 padding_left_0 padding_right_0 clearfix">
            <h4 class="theme-box-heading accordion collapsed" data-toggle="collapse" data-target="#sahayak_grid" aria-expanded="true" aria-controls="competitor_grid">
                    Probable Sahayak
                </h4>
            </div>
            <div class="col-sm-12 collapse" id="sahayak_grid">
                <?=
        ...
        <div class="col-md-12 view-subtitle padding_10_0 theme-box ">
            <div class="col-sm-12 col-md-12 padding_left_0 padding_right_0 clearfix">
            <h4 class="theme-box-heading accordion collapsed" data-toggle="collapse" data-target="#member_grid" aria-expanded="true" aria-controls="competitor_grid">
                    Probable Member
                </h4>
            </div>
            <div class="col-sm-12 collapse" id="member_grid">
                <?=
        ...
        <div class="col-md-12 view-subtitle padding_10_0 theme-box ">
            <div class="col-sm-12 col-md-12 padding_left_0 padding_right_0 clearfix">
                <h4 class="theme-box-heading accordion collapsed" data-toggle="collapse" data-target="#document_grid" aria-expanded="true" aria-controls="competitor_grid">Document Upload</h4>
            </div>
