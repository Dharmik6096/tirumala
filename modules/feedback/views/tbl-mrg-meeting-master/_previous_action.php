...
$grid_option = [
    ...
    'actions' => [
        'update' => function ($url, $model) {
            $options = ['data-toggle' => 'tooltip', 'data-placement' => 'top', 'data-val' => $model->MRG_previous_actions_id];
            return GhostHtml::a('<i class="fa fa-pencil"></i>', ['/feedback/tbl-mrg-meeting-previous-actions/update', 'id' => $model->MRG_previous_actions_id], $options);
        },
    ]
];
?>
