    ...
    <div class="row">
        <div class="col-md-12 view-subtitle padding_10_0 theme-box ">
            <div class="col-sm-12 col-md-12 padding_left_0 padding_right_0 clearfix">
                <h4 class="theme-box-heading accordion collapsed" data-toggle="collapse" data-target="#current_pouring_grid" aria-expanded="true" aria-controls="current_pouring_grid">
                    Current Pouring
                </h4>
            </div>
            <div class="col-sm-12 collapse" id="current_pouring_grid">
                <?=
