...
$grid_option = [
    ...
    'actions' => [
        'edit' => function ($url, $model) {
            $options = ['data-bs-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Edit', 'class' => 'edit-record', 'data-val' => $model->incentive_deduction_id, 'data-name' => $model->incentive_deduction_id, 'title' => Yii::t('app', 'Edit')];
