...
<div class="panel panel-default panel-main">
    <div class="panel-body">
        <div class="row theme_border_left theme_border_right theme_border_bottom">
            ...
            <div class="col-md-6 padding_10_0 theme-box">
                <div class="col-sm-12 col-md-12  margin-bottom-10 padding_left_0 padding_right_0 clearfix">
                    <h4 class="theme-box-heading">Animal Type Details</h4>
                </div>
                <div class="form-grid">
                    <?php
                    $attribute = [
                            ['attribute' => 'animal_type_code', 'filter' => FALSE],
                            ['attribute' => 'animal_type_name', 'filter' => FALSE],
                            ['attribute' => 'short_name', 'filter' => FALSE],
                            ['attribute' => 'is_milch', 'filter' => FALSE, 'value' => function($model) {
                                return ($model->is_milch == 1) ? Yii::t('app', 'Yes') : Yii::t('app', 'No');
                            }],
                    ];
                    $grid_option = [
                        'id' => 'backendDataAnimalType-list',
                        'attributes' => $attribute,
                        'active_column' => false,
                    ];
                    Yii::$app->grid->bind($animalTypeData, $animalTypeModel, $grid_option);
                    ?>
                </div>
            </div>
        </div>
