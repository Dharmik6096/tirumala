...
/* @var $searchModel app\modules\general\models\TblGenderSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Tbl Genders');
    ...
    <div class="panel-heading"><?= Html::encode($this->title) ?>
        <div class="dropdown pull-right shortcut-main" shortcut="true" display_shortcut="false" highlight_shortcut="true">
            ...
            <ul class="dropdown-menu">
                <li><?= Yii::$app->controls->add('gender'); ?></li>
            </ul>
        </div>
    </div>
    <?php // echo $this->render('_search', ['model' => $searchModel]);  ?>
<!--    <p>
    <?php //Html::a(Yii::t('app', 'Create Tbl Gender'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>-->
