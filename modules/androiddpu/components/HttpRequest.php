...
class HttpRequest extends \yii\base\Component {
    ...
    public $content = [];
    public $req_url;
    public $is_free = ['android-dpu/register', 'android-dpu/verification', 'realtime-services/dpu-product-stock', 'esp-app/register', 'esp-app/verification', 'android-dpu/send-otp', 'android-dpu/change-password'];
    public $request;
