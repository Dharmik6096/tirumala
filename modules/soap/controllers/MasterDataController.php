...
//                    
                        Yii::$app->db->createCommand("insert into tbl_purchase_rate_applicability (created_at,created_by,is_active,updated_at,updated_by,wef_date,dcs_code,purchase_rate_code,shift_code,union_code,rate_type,rate_gen_method_code,download_date_time,is_download,originating_org_code,originating_org_type,originating_type,shift_applicability) select created_at,created_by,is_active,updated_at,updated_by,wef_date,dcs_code,purchase_rate_code,shift_code,union_code,rate_type,rate_gen_method_code,download_date_time,0,originating_org_code,originating_org_type,originating_type,shift_applicability from tbl_purchase_rate_applicability_pending where purchase_rate_code=:purchase_rate_code")
