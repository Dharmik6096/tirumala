                                ...
                                <div class="modal-body">
                                    ...
                                    foreach ($param as $key => $value) {
                                        ...
                                        if (isset($value_array[1]) && $value_array[1] == 'string') {
                                            ...
                                            if (isset($value_array[2])) {
                                                ...
                                                <div class="col-sm-4 shift">
                                                    <?php
                                                    echo Yii::$app->dropdown->dropdown('shift_applicability', $model, $form, 'col-sm-4 form-group', $model->getAttributeLabel($value_array[2]), false, $value_array[2]);
                                                    ?>
                                                </div>    
                                                <?php
                                            }
                                        ...
                                        if (in_array($value, array('dcs_code'))) {
                                            ?>
                                            <div class="col-sm-4 val_dcs_code">
