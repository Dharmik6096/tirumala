...
//                    $attr[] = ['attribute' => $att, 'label' => Yii::t('app', $str), 'format' => $format, 'filter' => false];
        ...
        <?php
        if (!empty($fileDownloadArr)) {
            echo GhostHtml::submitButton('<i class="text-white far fa-file"></i>', ['class' => 'btn-login btn btn-default submit_btn downloadSapFiles apply-shortcut', 'name' => 'download', 'value' => 'download', 'id' => 'download', 'title' => Yii::t('app', 'download')]);
