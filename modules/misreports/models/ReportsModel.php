...
class ReportsModel extends Model {
    ...
    public function rules() {
        return [
            ...
            [['language_code', 'union_code','from_soc', 'to_soc', 'from_date', 'to_code'], 'required', 'on' => ['TrucksheetComparisionReport']],
        ];
    }
