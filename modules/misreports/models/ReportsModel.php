...
class ReportsModel extends Model {
    ...
    public $deviation_days, $deviation_value, $deviation_type, $search_by_farmer;
    ...
    public function rules() {
        return [
            ...
            [['to_code'], 'default', 'value' => 9999, 'on' => ['MilkPurchaseRegisterReport', 'FarmerLedgerReport', 'MemberWiseSummaryReport', 'MilkEditReport', 'MilkPurchaseAnalysis', 'FarmerListReport', 'MilkCompare', 'SmsDetailReport']],
            ...
            [['language_code', 'union_code','from_soc', 'to_soc', 'from_date', 'to_date'], 'required', 'on' => ['TrucksheetComparisionReport']],
            [['language_code', 'union_code','from_soc', 'to_soc', 'from_date', 'to_date', 'from_shift', 'to_shift', 'plant_code', 'generation_type'], 'required', 'on' => ['TrucksheetDetailReport']],
            [['language_code', 'union_code', 'dcs_code', 'date', 'shift', 'milk_type_code', 'deviation_days', 'deviation_value', 'deviation_type', 'search_by_farmer'], 'required', 'on' => ['FarmerFatAndWtDeviationReport']],
            [['deviation_days'], 'number', 'min' => 1, 'max' => 30, 'on' => ['FarmerFatAndWtDeviationReport']],
            [['deviation_value'], 'number', 'min' => 1, 'max' => 9999, 'on' => ['FarmerFatAndWtDeviationReport']],
        ];
    }
