...
class ReportsModel extends Model {
    ...
    public $deviation_days, $deviation_value, $deviation_type, $financial_year, $transaction_type, $sorttype, $show_account_code_no, $for, $is_department, $balance_separate, $zero_bal_acc_show, $show_seprate_acc_head;
    ...
    public function rules() {
        return [
            ...
            [['to_code'], 'default', 'value' => 99999, 'on' => ['LocalSaleReport', 'MilkRateDetailReport', 'DateWiseMilkPurchaseSummary', 'FatWiseQtyAnalysis', 'UnionWiseMessageDetailReport', 'SocietyWiseSummaryReport', 'FarmerNotSubmittingMilkReport', 'TrucksheetComparisionReport', 'TrucksheetDetailReport']],
            ...
            [['language_code', 'union_code', 'dcs_code', 'sorttype', 'from_date', 'to_date', 'show_account_code_no'], 'required', 'on' => ['BalanceSheetReport', 'TrialBalanceReport']],
            [['language_code', 'union_code', 'dcs_code', 'sorttype', 'from_date', 'to_date', 'show_account_code_no', 'for'], 'required', 'on' => ['ProfitAndLossReport', 'TradingAccountReport']],
        ];
    }
    ...
    public function attributeLabels() {
        return [
            ...
            'from_code' => (in_array($this->scenario, ['MilkEditReport', 'MilkEditSummary', 'MilkCompare', 'FarmerListReport', 'MemberWiseSummaryReport', 'FarmerWiseYearlyEditReport'])) ? \Yii::t('app', 'From Member') : ((in_array($this->scenario, ['DateWiseMilkPurchaseSummary', 'MilkRateDetailReport', 'FatWiseQtyAnalysis', 'SocietyWiseSummaryReport', 'LocalSaleReport', 'UnionWiseMessageDetailReport', 'FarmerNotSubmittingMilkReport', 'TrucksheetComparisionReport', 'TrucksheetDetailReport'])) ? \Yii::t('app', 'From Society') : \Yii::t('app', 'From Code')),
            'to_code' => (in_array($this->scenario, ['MilkEditReport', 'MilkEditSummary', 'MilkCompare', 'FarmerListReport', 'MemberWiseSummaryReport', 'FarmerWiseYearlyEditReport'])) ? \Yii::t('app', 'To Member') : ((in_array($this->scenario, ['DateWiseMilkPurchaseSummary', 'MilkRateDetailReport', 'FatWiseQtyAnalysis', 'SocietyWiseSummaryReport', 'LocalSaleReport', 'UnionWiseMessageDetailReport', 'FarmerNotSubmittingMilkReport', 'TrucksheetComparisionReport', 'TrucksheetDetailReport'])) ? \Yii::t('app', 'To Society') : \Yii::t('app', 'To Code')),
            ...
            'sorttype' => \Yii::t('app', 'Sort Type'),
            'show_account_code_no' => ($this->scenario == 'TradingAccountReport') ? \Yii::t('app', 'Show AccountCodeNo/Code') : \Yii::t('app', 'Show AccountCodeNo'),
            'is_department' => \Yii::t('app', 'Department'),
        ];
    }
