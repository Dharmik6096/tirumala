...
class ReportsModel extends Model {
    ...
    public function attributeLabels() {
        return [
            ...
            'show_only_received_data' => \Yii::t('app', 'Show Only Received Data'),
        ];
    }
