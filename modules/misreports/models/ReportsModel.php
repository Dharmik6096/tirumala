...
class ReportsModel extends Model {
    ...
    public $deviation_days, $deviation_value, $deviation_type, $financial_year, $transaction_type, $for, $balance_separate, $zero_bal_acc_show, $show_seprate_acc_head;
    ...
    public function rules() {
        return [
            ...
            [['to_code'], 'default', 'value' => 99999, 'on' => ['LocalSaleReport', 'MilkRateDetailReport', 'DateWiseMilkPurchaseSummary', 'FatWiseQtyAnalysis', 'UnionWiseMessageDetailReport', 'SocietyWiseSummaryReport', 'FarmerNotSubmittingMilkReport', 'TrucksheetComparisionReport', 'TrucksheetDetailReport', 'DateWiseCashBalanceReport']],
    ...
    public function attributeLabels() {
        return [
            ...
            'from_code' => (in_array($this->scenario, ['MilkEditReport', 'MilkEditSummary', 'MilkCompare', 'FarmerListReport', 'MemberWiseSummaryReport', 'FarmerWiseYearlyEditReport', 'FarmerDeductionLedgerReport'])) ? \Yii::t('app', 'From Member') : ((in_array($this->scenario, ['DateWiseMilkPurchaseSummary', 'MilkRateDetailReport', 'FatWiseQtyAnalysis', 'SocietyWiseSummaryReport', 'LocalSaleReport', 'UnionWiseMessageDetailReport', 'FarmerNotSubmittingMilkReport', 'TrucksheetComparisionReport', 'TrucksheetDetailReport', 'DateWiseCashBalanceReport'])) ? \Yii::t('app', 'From Society') : \Yii::t('app', 'From Code')),
            'to_code' => (in_array($this->scenario, ['MilkEditReport', 'MilkEditSummary', 'MilkCompare', 'FarmerListReport', 'MemberWiseSummaryReport', 'FarmerWiseYearlyEditReport', 'FarmerDeductionLedgerReport'])) ? \Yii::t('app', 'To Member') : ((in_array($this->scenario, ['DateWiseMilkPurchaseSummary', 'MilkRateDetailReport', 'FatWiseQtyAnalysis', 'SocietyWiseSummaryReport', 'LocalSaleReport', 'UnionWiseMessageDetailReport', 'FarmerNotSubmittingMilkReport', 'TrucksheetComparisionReport', 'TrucksheetDetailReport', 'DateWiseCashBalanceReport'])) ? \Yii::t('app', 'To Society') : \Yii::t('app', 'To Code')),
