...
class ReportsModel extends Model
{
    ...
    public $milk_type_code, $sort_type, $language_code, $member_types, $code, $from_code, $to_code;
...
return $('#reportsmodel-org_type').val() == 'DCS';
            ...
            [
                ...
                'skipOnEmpty' => false,
                'on' => ['MemberDailyCollection', 'MilkCollectionData', 'DpuRateComparision']
            ],
            [
                ['to_date'],
                function ($attribute, $params) {
                ...
                'skipOnEmpty' => false,
                'except' => ['MemberDailyCollection', 'MilkCollectionData', 'MemberMilkBill']
            ],
            ...
            [['union_code', 'dcs_code', 'date', 'shift', 'milk_type_code', 'member_types', 'sort_type'], 'required', 'on' => ['MilkPurchaseRegisterReport']],
            [
                ['code'],
                'required',
                'when' => function ($model) {
