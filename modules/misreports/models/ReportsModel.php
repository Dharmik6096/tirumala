...
class ReportsModel extends Model {
    ...
    public $rate_cal_for, $date_payment_cycle, $store_location_code, $is_groupbyserial;
    ...
    public function rules() {
        return [
                ...
                [['union_code', 'plant_code', 'from_date', 'from_shift', 'to_date', 'to_shift'], 'required', 'on' => ['BmcCollectionData', 'VendorPayment', 'VspTransitRecovery', 'MilkDispatchList', 'MilkRejectList', 'CmpReport']],
...
return $('#reportsmodel-org_type').val() == 'DCS';
              ...
              return $('#reportsmodel-basis_on').val() == '1' || $('#reportsmodel-basis_on').val() == '2';
                ...
                [['store_location_type', 'store_location_code'], 'required', 'on' => ['AssetDetailSummary']],
        ];
    }
