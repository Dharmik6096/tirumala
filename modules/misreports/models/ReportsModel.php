...
class ReportsModel extends Model {
    ...
    public $year, $month, $union_code, $plant_code, $mcc_code, $bmc_code, $dcs_code, $from_date, $from_shift, $to_date, $to_shift, $report_type, $date, $shift, $show_detail, $purchase_type, $sales_type, $is_date_wise_group, $item;
    ...
    public $milk_type_code, $sort_type, $language_code, $member_types, $from_code, $to_code, $shift_code, $is_show_zero_val, $payment_method, $report_rate_type, $amount_variation, $sort_by, $search_by, $edit_type, $is_group_by_society, $search_type, $last_rate, $report_sort_by, $sort_direction, $from_soc, $to_soc, $farmer_type, $report_member_type, $filter_type, $milk_sort_by, $status_type, $society_type, $region_type, $farmer_sort_type, $registered_type, $group_by_region, $soc_type, $show_only_received_data, $report_status_type, $sms_type, $mobile_no, $top, $report_gender, $search_by_soc, $manual_type, $show_val, $no_of_farmer_edit, $no_of_individual_farmer_edit, $report_app_type, $from_time, $to_time, $storage_type, $generation_type;
    public $deviation_days, $deviation_value, $deviation_type, $financial_year, $transaction_type, $for, $balance_separate, $zero_bal_acc_show, $show_seprate_acc_head, $farmer_sort_by, $farmer_status, $only, $consider_op_bal, $show_report_in_single_row, $consider_sample_milk, $show_centralize_payment_only, $ded_from_date, $ded_to_date, $report_deviation_type, $deviation_qty, $deviation_fat, $bank_account, $from_validation, $to_validation, $filter_by, $order_by, $do_not_show_zero, $from_validation_type, $to_validation_type, $show_milko_screen_sample;
    ...
    public function rules() {
        return [
            ...
            [['to_validation'], 'default', 'value' => 9999, 'on' => ['SocietyWiseToleranceReport']],
            [['top'], 'default', 'value' => 10, 'on' => ['TopSocietyMilkCollectionReport', 'TopFarmerMilkCollectionReport', 'TopRegionsMilkCollectionReport']],
            ...
            [['year', 'union_code', 'plant_code', 'mcc_code', 'bmc_code', 'dcs_code', 'from_date', 'from_shift', 'to_date', 'to_shift', 'p_date', 'customer_code', 'member_code', 'rate_type', 'customer_type', 'vendor_code', 'payment_cycle_code', 'report_status', 'member_type', 'route_code', 'no_of_payment_cycle', 'output_type', 'report_type', 'store_location_type', 'asset_code', 'sap_code', 'sr_no', 'main_customer_type', 'transporter_code', 'vehicle_code', 'originating_type', 'report_collection_type', 'type_wise_report', 'route_type_trans', 'product_code', 'org_type', 'product_type', 'module_type', 'action_perform', 'channel_code', 'upload_ftp_file', 'sap_file', 'channel_code', 'month', 'state_code', 'region_code', 'area_code', 'report_req_status', 'login_user_code', 'user_code', 'as_on_date', 'basis_on', 'top_collection_on', 'param_type', 'top_value', 'milk_type', 'f_spr_date', 't_spr_date', 'f_cmpr_date', 't_cmpr_date', 'animal_type', 'current_status', 'login_type', 'user_login_type', 'insurance_master_code', 'operation_type', 'bank_type', 'trip_status', 'trip_code', 'milk_sale_on', 'billing_on', 'dispatch_center_type', 'dispatch_center', 'dispatch_type', 'date_payment_cycle', 'bank_type', 'trip_status', 'trip_code', 'date_payment_cycle', 'store_location_code', 'is_groupbyserial', 'store_location_type_all', 'product_group_code', 'header_reference', 'assignment', 'department', 'bill_head_code', 'p_product_type', 'master_type', 'sort_type', 'milk_type_code', 'language_code', 'member_types', 'from_code', 'to_code', 'shift_code', 'is_show_zero_val', 'payment_method', 'report_rate_type', 'amount_variation', 'sort_by', 'search_by', 'edit_type', 'is_group_by_society', 'search_type', 'last_rate', 'is_show_zero_val', 'report_sort_by', 'sort_direction', 'from_soc', 'to_soc', 'report_member_type', 'farmer_type', 'filter_type', 'milk_sort_by', 'society_type', 'status_type', 'region_type', 'registered_type', 'farmer_sort_type', 'group_by_region', 'soc_type', 'show_only_received_data', 'report_status_type', 'sms_type', 'mobile_no', 'top', 'report_gender', 'search_by_soc', 'show_val', 'manual_type', 'no_of_farmer_edit', 'no_of_individual_farmer_edit', 'report_app_type', 'from_time', 'to_time', 'storage_type', 'generation_type', 'deviation_days', 'deviation_value', 'deviation_type', 'financial_year', 'transaction_type', 'for', 'balance_separate', 'zero_bal_acc_show', 'show_seprate_acc_head', 'show_detail', 'purchase_type', 'sales_type', 'item', 'is_date_wise_group', 'farmer_sort_by', 'farmer_status', 'search_by_farmer', 'only', 'consider_op_bal', 'show_report_in_single_row', 'consider_sample_milk', 'show_centralize_payment_only', 'ded_from_date', 'ded_to_date', 'bank_account', 'report_deviation_type', 'deviation_qty', 'deviation_fat', 'from_validation', 'to_validation', 'filter_by', 'order_by', 'do_not_show_zero', 'from_validation_type', 'to_validation_type', 'show_milko_screen_sample'], 'safe'],
            ...
            [['to_date'], function ($attribute, $params) {
                ...
                }, 'skipOnEmpty' => false, 'except' => ['MemberDailyCollection', 'MilkCollectionData', 'MemberMilkBill', 'MilkCompare', 'FarmerLedgerReport', 'MemberWiseSummaryReport', 'LocalSaleReport', 'LocalSaleDetailReport', 'MilkRateDetailReport', 'MilkEditReport', 'DateWiseMilkPurchaseSummary', 'MilkEditSummary', 'FatWiseQtyAnalysis', 'UnionWiseMessageDetailReport', 'UnionWiseMessageReport', 'TopSocietyMilkCollectionReport', 'TopFarmerMilkCollectionReport', 'FarmerManualEntryReport', 'SocietyWiseSummaryReport', 'FarmerNotSubmittingMilkReport', 'ManualCollectionSummaryReport', 'MilkEditForFarmerReport', 'SocietySampleReport', 'TrucksheetComparisionReport', 'TopRegionsMilkCollectionReport', 'TrucksheetDetailReport']],
            [['to_date'], function ($attribute, $params) {
                    Yii::$app->general->dateRangeValidate($this, $attribute, $params, 'from_date', 'to_date', 31, '>', 'Day Difference can not be greater than 31.');
                }, 'skipOnEmpty' => false, 'on' => ['FarmerLedgerReport', 'MemberWiseSummaryReport', 'LocalSaleReport', 'LocalSaleDetailReport', 'MilkRateDetailReport', 'MilkEditReport', 'DateWiseMilkPurchaseSummary', 'MilkEditSummary', 'FatWiseQtyAnalysis', 'UnionWiseMessageDetailReport', 'UnionWiseMessageReport', 'TopSocietyMilkCollectionReport', 'TopFarmerMilkCollectionReport', 'FarmerManualEntryReport', 'SocietyWiseSummaryReport', 'FarmerNotSubmittingMilkReport', 'ManualCollectionSummaryReport', 'MilkEditForFarmerReport', 'SocietySampleReport', 'TrucksheetComparisionReport', 'TopRegionsMilkCollectionReport', 'TrucksheetDetailReport', 'DateWiseCashBalanceReport', 'ItemPurchaseGstReport', 'ItemSalesGstReport', 'StockStatementReport', 'StockLedgerReport', 'LedgerReport', 'FarmerDeductionLedgerReport', 'TradingAccountReport', 'ProfitAndLossReport', 'ProfitAndLossReport', 'BalanceSheetReport', 'TrialBalanceReport']],
            ...
            [['language_code', 'union_code', 'from_date', 'to_date', 'top'], 'required', 'on' => ['TopSocietyMilkCollectionReport', 'TopRegionsMilkCollectionReport']],
            ...
            [['region_code'], 'required', 'on' => ['TopRegionsMilkCollectionReport']],
            [['language_code', 'union_code', 'date', 'storage_type'], 'required', 'on' => ['DailySummaryReport']],
            [['language_code', 'union_code', 'from_code', 'to_code', 'from_date', 'to_date'], 'required', 'on' => ['TrucksheetComparisionReport']],
            [['language_code', 'union_code', 'from_code', 'to_code', 'from_date', 'to_date', 'generation_type'], 'required', 'on' => ['TrucksheetDetailReport']],
            [['language_code', 'union_code', 'dcs_code', 'date', 'shift_code', 'milk_type_code', 'deviation_days', 'deviation_type'], 'required', 'on' => ['FarmerFatAndWtDeviationReport']],
            [['deviation_days'], 'number', 'min' => 1, 'max' => 30, 'on' => ['FarmerFatAndWtDeviationReport']],
            [['deviation_value'], 'number', 'min' => 0, 'max' => 9999, 'on' => ['FarmerFatAndWtDeviationReport']],
            [['language_code', 'union_code', 'dcs_code', 'financial_year', 'from_code', 'to_code'], 'required', 'on' => ['FarmerWiseYearlyEditReport']],
            [['from_shift', 'to_shift'], 'required', 'when' => function ($model) {
                    return $model->generation_type == 2;
                }, 'whenClient' => "function (attribute, value) {
            ...
            [['union_code', 'plant_code', 'mcc_code', 'bmc_code', 'from_date', 'to_date', 'transaction_type'], 'required', 'on' => ['UnionActiveSummary']],
            [['language_code', 'union_code', 'dcs_code', 'from_date', 'to_date'], 'required', 'on' => ['BalanceSheetReport', 'TrialBalanceReport']],
            [['language_code', 'union_code', 'dcs_code', 'from_date', 'to_date', 'for'], 'required', 'on' => ['ProfitAndLossReport', 'TradingAccountReport']],
            [['language_code', 'union_code', 'dcs_code', 'from_date', 'to_date', 'purchase_type'], 'required', 'on' => ['ItemPurchaseGstReport']],
            [['language_code', 'union_code', 'dcs_code', 'from_date', 'to_date', 'payment_method', 'sales_type'], 'required', 'on' => ['ItemSalesGstReport']],
            [['language_code', 'union_code', 'dcs_code', 'from_date', 'to_date'], 'required', 'on' => ['StockStatementReport']],
            [['language_code', 'union_code', 'dcs_code', 'from_date'], 'required', 'on' => ['CashBookReport']],
            ...
            [['language_code', 'union_code', 'region_code', 'from_soc', 'to_soc', 'from_date', 'to_date', 'ded_from_date', 'ded_to_date', 'from_validation', 'to_validation', 'filter_by', 'order_by'], 'required', 'on' => ['SocietyWiseToleranceReport']],
    ...
    public function attributeLabels() {
        return [
            ...
            'to_date' => in_array($this->scenario, ['MilkCompare', 'FarmerWiseToleranceReport']) ? \Yii::t('app', 'Compare Date') : \Yii::t('app', 'To Date'),
            'to_shift' => in_array($this->scenario, ['MilkCompare', 'FarmerWiseToleranceReport']) ? \Yii::t('app', 'Compare Shift') : \Yii::t('app', 'To Shift'),
            ...
            'member' => ($this->scenario == 'FarmerFatAndWtDeviationReport') ? \Yii::t('app', 'Search By Farmer') : \Yii::t('app', 'Member'),
            ...
            'from_code' => (in_array($this->scenario, ['MilkEditReport', 'MilkEditSummary', 'MilkCompare', 'FarmerListReport', 'MemberWiseSummaryReport', 'FarmerWiseYearlyEditReport', 'FarmerDeductionLedgerReport', 'MilkEditOnlineReport', 'FarmerWiseToleranceReport'])) ? \Yii::t('app', 'From Member') : ((in_array($this->scenario, ['DateWiseMilkPurchaseSummary', 'MilkRateDetailReport', 'FatWiseQtyAnalysis', 'SocietyWiseSummaryReport', 'LocalSaleReport', 'UnionWiseMessageDetailReport', 'FarmerNotSubmittingMilkReport', 'TrucksheetComparisionReport', 'TrucksheetDetailReport', 'DateWiseCashBalanceReport'])) ? \Yii::t('app', 'From Society') : \Yii::t('app', 'From Code')),
            'to_code' => (in_array($this->scenario, ['MilkEditReport', 'MilkEditSummary', 'MilkCompare', 'FarmerListReport', 'MemberWiseSummaryReport', 'FarmerWiseYearlyEditReport', 'FarmerDeductionLedgerReport', 'MilkEditOnlineReport', 'FarmerWiseToleranceReport'])) ? \Yii::t('app', 'To Member') : ((in_array($this->scenario, ['DateWiseMilkPurchaseSummary', 'MilkRateDetailReport', 'FatWiseQtyAnalysis', 'SocietyWiseSummaryReport', 'LocalSaleReport', 'UnionWiseMessageDetailReport', 'FarmerNotSubmittingMilkReport', 'TrucksheetComparisionReport', 'TrucksheetDetailReport', 'DateWiseCashBalanceReport'])) ? \Yii::t('app', 'To Society') : \Yii::t('app', 'To Code')),
            ...
            'generation_type' => \Yii::t('app', 'Generation Type'),
            'deviation_days' => \Yii::t('app', 'Deviation Days'),
            'deviation_value' => \Yii::t('app', 'Deviation Value'),
            'deviation_type' => \Yii::t('app', 'Deviation Type'),
            'transaction_type' => \Yii::t('app', 'Transaction Type'),
            'show_detail' => \Yii::t('app', 'Show Detail'),
            'purchase_type' => \Yii::t('app', 'Purchase Type'),
            'sales_type' => \Yii::t('app', 'Sales Type'),
            'item' => (in_array($this->scenario, ['LedgerReport', 'FarmerDeductionLedgerReport'])) ? \Yii::t('app', 'Account') : \Yii::t('app', 'Item'),
            'is_date_wise_group' => \Yii::t('app', 'Is Date Wise Group'),
            'farmer_sort_by' => \Yii::t('app', 'Sort By'),
            'search_by_farmer' => \Yii::t('app', 'Search By Farmer'),
            'farmer_status' => \Yii::t('app', 'Farmer Status'),
            'report_deviation_type' => \Yii::t('app', 'Deviation Type'),
            'deviation_qty' => \Yii::t('app', 'Deviation Qty'),
            'deviation_fat' => \Yii::t('app', 'Deviation Fat'),
            'do_not_show_zero' => \Yii::t('app', 'Do Not Show Zero'),
            'user_code' => ($this->scenario == 'UserAttendanceTransactionDetailReport') ? \Yii::t('app', 'User') : \Yii::t('app', 'User Name'),
            'filter_by' => \Yii::t('app', 'Filter By'),
            'order_by' => \Yii::t('app', 'Order By'),
            'from_validation_type' => \Yii::t('app', 'From Validation Type'),
            'to_validation_type' => \Yii::t('app', 'To Validation Type'),
            'bank_account' => \Yii::t('app', 'Bank Account'),
            'ded_from_date' => ($this->scenario == 'SocietyWiseToleranceReport') ? \Yii::t('app', 'Compare From Date') : \Yii::t('app', 'Ded From Date'),
            'ded_to_date' => ($this->scenario == 'SocietyWiseToleranceReport') ? \Yii::t('app', 'Compare To Date') : \Yii::t('app', 'Ded To Date'),
        ];
    }
