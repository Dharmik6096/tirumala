...
class ReportsModel extends Model {
    ...
    public function rules() {
        return [
            ...
            [['union_code', 'plant_code', 'mcc_code', 'from_date', 'from_shift', 'to_date', 'to_shift'], 'required', 'on' => ['CcMilkPayment', 'MilkCollectionNegativeGroth', 'RootWiseDifference', 'AppStartupReport', 'MemberPaymentShortageRecovery']],
