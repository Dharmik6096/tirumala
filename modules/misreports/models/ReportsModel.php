    ...
    public function rules() {
        return [
            ...
            [['to_date'], function ($attribute, $params) {
                ...
                }, 'skipOnEmpty' => false, 'on' => ['FarmerLedgerReport', 'MemberWiseSummaryReport', 'LocalSaleReport', 'LocalSaleDetailReport', 'MilkRateDetailReport', 'MilkEditReport', 'DateWiseMilkPurchaseSummary', 'MilkEditSummary', 'FatWiseQtyAnalysis', 'MilkCompare', 'UnionWiseMessageDetailReport', 'UnionWiseMessageReport', 'TopSocietyMilkCollectionReport', 'TopFarmerMilkCollectionReport', 'FarmerManualEntryReport', 'SocietyWiseSummaryReport', 'FarmerNotSubmittingMilkReport', 'ManualCollectionSummaryReport', 'MilkEditForFarmerReport', 'SocietySampleReport', 'TrucksheetComparisionReport', 'TopRegionsMilkCollectionReport', 'TrucksheetDetailReport', 'CashBookReport', 'DateWiseCashBalanceReport', 'ItemPurchaseGstReport', 'ItemSalesGstReport', 'StockStatementReport', 'StockLedgerReport', 'LedgerReport', 'FarmerDeductionLedgerReport', 'TradingAccountReport', 'ProfitAndLossReport', 'ProfitAndLossReport', 'BalanceSheetReport', 'TrialBalanceReport']],
            ...
            [['language_code', 'union_code', 'dcs_code', 'from_date', 'to_date'], 'required', 'on' => ['StockStatementReport', 'CashBookReport']],
