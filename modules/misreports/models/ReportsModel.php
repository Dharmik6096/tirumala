...
class ReportsModel extends Model {
    ...
    public $org_type, $product_type, $module_type, $action_perform, $channel_code, $upload_ftp_file, $sap_file, $trip_code, $grn_no;
...
return $('#reportsmodel-org_type').val() == 'DCS';
                ...
                [['plant_code', 'mcc_code', 'from_date', 'to_date'], 'required', 'on' => ['BmcRegister']],
                [['union_code', 'plant_code', 'from_date', 'to_date'], 'required', 'on' => ['PlantRegister']],
