...
class ReportsModel extends Model {
    ...
    public $calibration_day, $p_date, $customer_code, $member_code, $p_organization_type, $p_purchase_rate_code, $rate_type, $customer_type, $vendor_code, $payment_cycle_code, $report_status, $member_type, $route_code;
    ...
    public function rules() {
        return [
            ...
            [['union_code', 'plant_code', 'from_date', 'from_shift', 'to_date', 'to_shift', 'report_status'], 'required', 'on' => ['CdaDateAndShiftWise', 'CdaConsolidated', 'VariationVillageWise', 'VariationPercentageWise', 'BmcCollectionConsolidated', 'CdaDateWise']],
        ];
    }
