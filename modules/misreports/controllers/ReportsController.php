...
//        exit();
        ...
        if (isset($this->data['downloadFormat']) && $this->data['downloadFormat'] == 'csv') {
            ...
            $isZip = isset($this->data['link']) && $this->data['link'] == true;
            if (!in_array('zip_link', $file_header) && $isZip) {
                $file_header[] = 'zip_link';
            }
