...
class TblMilkVehicleEntryHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
                ...
                [['originating_org_code', 'originating_org_type', 'receipt_at_code', 'dispatch_from', 'dispatch_from_code', 'receipt_datetime', 'receipt_shift_code', 'tanker_no', 'approved_at', 'approved_by', 'approval_status', 'approval_remarks'], 'safe'],
        ];
    }
