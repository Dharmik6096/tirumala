...
class TblMilkVehicleEntry extends \app\models\ChildModel {
    ...
    public function attributeLabels() {
        return [
            ...
            'receipt_at' => Yii::t('app', 'Source Type'),
            ...
            'receipt_at_code' => Yii::t('app', 'Source Name'),
            'dispatch_from' => Yii::t('app', 'Destination Type'),
            'dispatch_from_code' => Yii::t('app', 'Destination Name'),
