...
class TblMaterialMasterHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
                [['union_code', 'ref_code', 'created_at', 'updated_at', 'history_created_at', 'material_name', 'local_name', 'created_by', 'updated_by', 'originating_org_code', 'originating_org_type', 'operation_type', 'history_created_by', 'material_code', 'is_active', 'originating_type'], 'safe'],
        ];
    }
