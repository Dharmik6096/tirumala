...
/**
 * This is the model class for table "tbl_tanker_rate_auto".
 *
...
class TblTankerRateDetails extends \app\models\ChildModel {
    ...
    public static function tableName() {
        return 'tbl_tanker_rate_details';
    }
...
//            [['is_delete', 'milk_quality_type_code'], 'integer'],
    ...
    /**
     * @inheritdoc
     * @return TblTankerRateAutoQuery the active query used by this AR class.
     */
    public static function find() {
        return new TblTankerRateDetailsQuery(get_called_class());
    }
