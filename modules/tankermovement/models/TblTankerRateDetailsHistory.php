...
/**
 * This is the model class for table "tbl_tanker_rate_details_history".
 *
 * @property integer $id
...
class TblTankerRateDetailsHistory extends \yii\db\ActiveRecord
{
    ...
    {
        return 'tbl_tanker_rate_details_history';
    }
    ...
    /**
     * @inheritdoc
     * @return TblTankerRateDetailsHistoryQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new TblTankerRateDetailsHistoryQuery(get_called_class());
    }
}
