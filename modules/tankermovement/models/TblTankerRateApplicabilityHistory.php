...
/**
 * This is the model class for table "tbl_tanker_rate_applicability_history".
 *
 * @property integer $id
 ...
 */
class TblTankerRateApplicabilityHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_tanker_rate_applicability_history';
    }
