...
class TblBmcMilkDispatchTxn extends \app\models\ChildModel {
    ...
    public function rules() {
        $main_rules = [
            [['milk_quality_type_code', 'milk_type_code', 'dispatch_qty', 'fat', 'snf', 'water', 'temperature', 'bmc_silos_info_code', 'chamber_no', 'qty_diff_type_code', 'qty_diff', 'balance_qty'], 'required', 'except' => ['androidsync', 'createPlantDispatch', 'createPlantDispatchUpdate']],
