...
class TblBmcMilkDispatchTxn extends \app\models\ChildModel {
    ...
    public function rules() {
        $main_rules = [
            ...
            [['milk_type_code'], 'unique', 'targetAttribute' => ['milk_type_code', 'milk_quality_type_code', 'bmc_silos_info_code', 'chamber_no', 'bmc_milk_dispatch_code'], 'message' => Yii::t('app/validation', 'Chamber Entry for selected milk and silo has been already taken.'), 'on' => ['create', 'createApi']],
