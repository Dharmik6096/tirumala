...
$this->params['menu'][] = GhostHtml::a('<i class="fa fa-pencil"></i>' . Yii::t('app', 'Edit Trip Detail'), ['/tankermovement/tbl-milk-vehicle-entry/edit-trip-detail'], ['class' => 'btn btn-danger btn-block']);
