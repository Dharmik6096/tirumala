            ...
            <div class="containers collapsible-container <?php echo $class; ?>">
                ...
                <div class="collapsible sub_status_content">
                    <h5 style="left: -170px;">
                        ...
                        <strong class="label_heading"><?= !empty($lable_array[$header->trip_sub_status]) ? $lable_array[$header->trip_sub_status] : ucwords(str_replace('_', ' ', $track->trip_sub_status)) ?></strong>
                    </h5>
