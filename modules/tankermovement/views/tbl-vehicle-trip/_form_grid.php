...
$grid_option = [
    ...
    'actions' => [
        ...
        'replace-tanker' => function ($url, $model) {
            ...
            if ($disable) {
                return GhostHtml::a('<i class="fa fa-exchange-alt"></i>', ['/tankermovement/tbl-vehicle-trip/replace-tanker'], ['class' => 'disabled']);
            } else {
                ...
                return GhostHtml::a('<i class="fa fa-exchange-alt"></i>', ['/tankermovement/tbl-vehicle-trip/replace-tanker', 'old_trip_code' => $model->trip_code], $options);
            }
        },
