...
$this->params['menu'][] = GhostHtml::a('<i class="fa fa-pencil-alt"></i>' . Yii::t('app', 'Edit Trip Detail'), ['/tankermovement/tbl-bmc-milk-dispatch/edit-trip-detail'], ['class' => 'btn btn-danger btn-block']);
