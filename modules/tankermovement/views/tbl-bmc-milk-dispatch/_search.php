...
$depend = 'tblbmcmilkdispatchsearch';
?>

<div class="tbl-milk-collection-search">
    <?php
    $form = ActiveForm::begin([
                'id' => 'dispatch_trip_search',
                'method' => 'get',
    ...
    <div class="col-sm-2">
        <?= Yii::$app->dropdown->plant_mcc($model, $form, $depend . '-f_plant_code', 'f_mcc_code', Yii::t('app', 'MCC')); ?>
    </div> 
    <div class="col-sm-2">
...
<?php
$script = "
$('#dispatch_trip_search').submit(function(e){
    e.stopImmediatePropagation();
});";

$this->registerJs($script, View::POS_END, 'dispatch-trip-search');
?>