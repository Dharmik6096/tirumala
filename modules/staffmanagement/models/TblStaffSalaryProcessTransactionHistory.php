...
/**
 * This is the model class for table "tbl_staff_salary_process_transaction_history".
 *
 * @property integer $id
 ...
 */
class TblStaffSalaryProcessTransactionHistory extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_staff_salary_process_transaction_history';
    }
    ...
    {
        return [
            [['salary_transaction_code', 'salary_code', 'union_code', 'created_by', 'updated_by', 'originating_org_code', 'originating_org_type', 'x_col1', 'x_col2', 'x_col3', 'x_col4', 'x_col5', 'operation_type', 'history_created_by'], 'string'],
