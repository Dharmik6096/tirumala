...
<tr class="<?= $instlModel->installment_no ?>">
    ...
    <td class="installment_no"><a href="javascript:void(0)" class='edit' onClick="editSalaryInstall('<?= $instlModel->installment_no ?>')" id='<?= $instlModel->installment_no ?>' title='Edit'><span class='fa fa-pencil-alt'></span></a></td>
