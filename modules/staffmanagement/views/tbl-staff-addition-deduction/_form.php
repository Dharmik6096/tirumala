...
<div class="row">
    ...
    <div class="col-sm-2">
        <?= Yii::$app->dropdown->depend_dropdown('staff_member_code', $model, $form, 'tblstaffadditiondeduction-union_code', 'form-group col-sm-2 ' . $class, Yii::t('app', 'Name')); ?>
    </div>
    <?php if ($type == 'create') { ?>
    ...
    ?>
    <div class="col-sm-2">
        <?= Yii::$app->controls->date($model, $form, 'tr_date', 'form-group col-sm-2 ' . $class, true, $min, false, TRUE, FALSE, $max); ?>
    </div>
    ...
    <?= $form->field($model, 'amount', ['options' => ['class' => 'form-group col-sm-2']])->textInput() ?>
