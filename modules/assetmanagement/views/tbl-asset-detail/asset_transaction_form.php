    ...
    <div class="panel-body">
        ...
        <div class="single_entry_area col-sm-12 padding-left-0 padding-right-0">
            <div class="col-sm-12 padding-left-0 padding-right-0">
                ...
                <div class="col-sm-3 from_warehouse from_plant default_hide from_hide">
                ...
                <div class="col-sm-3 from_dsk default_hide from_hide">
            ...
            <div class="col-sm-12 padding-left-0 padding-right-0">
                ...
                <div class="col-sm-3 to_mcc to_dsk default_hide to_hide disa_drop">
                ...
                <div class="col-sm-3 default_hide to_hide disa_drop">
...
//            $('.add-serial-record').addClass('disabled no_pointer');
    ...
    $('.add-asset-record').on('click', function(){
        var from_type = $('#tblassettransaction-from_type').val();
        var to_type = $('#tblassettransaction-to_type').val();
        var from_mcc = $('#tblassettransaction-from_mcc').val();
        var to_mcc = $('#tblassettransaction-to_mcc').val();
        var from_dest = $('#tblassettransaction-from_dest').val();
        var asset_code = $('#tblassettransaction-asset_code').val();
        var qty = $('#tblassettransaction-qty').val();
        if(asset_code != ''){
        ...
        if(from_type != '' && from_dest != '' && asset_code != '' && qty != ''){
            $.ajax({
                ...
                data: {'from_type' : from_type, 'from_dest' : from_dest, 'asset_code' : asset_code, 'qty' : qty, 'to_type' : to_type, 'to_mcc' : to_mcc, 'from_mcc' : from_mcc},
...
//        checkInWard();
    ...
    $('#tblassettransaction-from_dest').on('change', function(){
     ...
     function setDcsData() {
        ...
        if(selectParam == 'dsk'){
            if(selectToParams == 'dsk' || selectToParams == 'mcc'){
