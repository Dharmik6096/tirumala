...
class TblAssetTransactionHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['received_date', 'created_at', 'updated_at', 'history_created_at', 'transaction_date', 'asset_type', 'sap_code', 'current_status', 'detail_code', 'manufacturer_serial_number'], 'safe'],
        ];
    }
