...
/**
 * This is the model class for table "tbl_asset_verification_data_history".
 *
 * @property integer $id
 ...
 */
class TblAssetVerificationDataHistory extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_asset_verification_data_history';
    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'asset_verification_data_code' => Yii::t('app', 'Asset Verification Data Code'),
