...
class TblEiplAppLogin extends \yii\db\ActiveRecord implements \yii\web\IdentityInterface {
    ...
    public function rules() {
        return [
            [['app_type', 'otp_code', 'sms_sent', 'is_active', 'is_expired'], 'integer'],
            [['eipl_code', 'mobile_no', 'master_type', 'master_code', 'login_type', 'module_type', 'module_code', 'imei_no', 'device_id', 'lat_long', 'access_token', 'auth_key', 'version_no', 'sms_log'], 'string'],
