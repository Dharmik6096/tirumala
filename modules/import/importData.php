...
class importData extends \yii\base\Module {
    ...
    public static function getLabels($l) {
        $label = [
            ...
            'bmc' => ['import_class' => 'bmc_import', 'table_name' => 'tbl_bmc', 'fields' => 'mcc_plant_code,bmc_code,bmc_type_code,bmc_name,local_name,model,capacity,manufacturer_code,bmc_milk_type,union_code,hamlet_code', 'default_fields' => 'is_active:1', 'scenario' => 'importCsv'],
