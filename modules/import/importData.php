...
class importData extends \yii\base\Module {
    ...
    public static function getLabels($l) {
        $label = [
            ...
            'dcs' => ['import_class' => 'dcs_import', 'import_main_class' => 'DcsImportStrategy', 'table_name' => 'tbl_dcs', 'fields' => 'union_code,bmc_code,dcs_code,dcs_name,local_name,dcs_short_name,local_short_name,dcs_code_ex,address,local_address,hamlet_code,milk_type_code,pincode,effective_date,phone_no,upi_no,dcs_type_code,pan_no,registration_code,registration_date,is_active,is_dispatch_mandate,is_weight_manual,is_quality_manual,dpu_type,rate_chart_member,contact_person,middle_name,surname,email,local_contact_person,local_lastname,local_surname,mobile_no,department,ifsc,bank_account_no', 'default_fields' => 'originating_type:1', 'scenario' => 'importCsv', 'mapping' => 1, 'mapping_model' => 'TblDcsMilkType', 'mapping_fields' => 'dcs_code,milk_type_code'],
