...
class importData extends \yii\base\Module {
    ...
    public static function getLabels($l) {
        $label = [
            ...
            'dcs' => ['import_class' => 'dcs_import', 'import_main_class' => 'DcsImportStrategy', 'table_name' => 'tbl_dcs', 'fields' => 'union_code,bmc_code,dcs_code,dcs_name,local_name,dcs_short_name,local_short_name,dcs_code_ex,address,local_address,hamlet_code,milk_type_code,pincode,effective_date,phone_no,upi_no,dcs_type_code,pan_no,registration_code,registration_date,is_active,is_dispatch_mandate,is_weight_manual,is_quality_manual,dpu_type,rate_chart_member,contact_person,local_contact_person,middle_name,local_middlename,surname,local_surname,email,mobile_no,department,ifsc,bank_account_no', 'default_fields' => 'originating_type:1', 'scenario' => 'importCsv', 'mapping' => 1, 'mapping_model' => 'TblDcsMilkType', 'mapping_fields' => 'dcs_code,milk_type_code'],
            ...
            'mcc-plant' => ['import_class' => 'mcc_plant_import', 'import_main_class' => 'CommonImportStrategy', 'table_name' => 'tbl_mcc_plant', 'fields' => 'union_code,mcc_plant_code_ex,ref_code,name,local_name,description,plant_code,hamlet_code,is_weight_manual,is_quality_manual', 'default_fields' => 'is_active:1', 'scenario' => 'importCsv', 'mapping' => 1, 'mapping_model' => 'TblMccMilkType', 'mapping_fields' => 'mcc_plant_code,milk_type_code'],
            ...
            'bmc' => ['import_class' => 'bmc_import', 'table_name' => 'tbl_bmc', 'fields' => 'mcc_plant_code,bmc_code,bmc_type_code,bmc_name,local_name,model,capacity,manufacturer_code,bmc_milk_type,union_code,hamlet_code,is_weight_manual,is_quality_manual', 'default_fields' => 'is_active:1', 'scenario' => 'importCsv', 'mapping' => 1, 'mapping_model' => 'TblBmcMilkType', 'mapping_fields' => 'bmc_code,milk_type_code'],
