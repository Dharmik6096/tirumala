...
class importData extends \yii\base\Module {
    ...
    public static function getLabels($l) {
        $label = [
            ...
            'dpu-incentive' => ['import_class' => 'tbl_dpu_incentive_master', 'import_main_class' => 'DpuIncentiveImportStrategy', 'table_name' => 'tbl_dpu_incentive_master', 'fields' => 'union_code,dcs_code,m_cutoff_time,e_cutoff_time,m_start_time,e_start_time,m_lock_time,e_lock_time,inc_rate,inc_deduction'],
        ];
        return $label[$l];
    }
