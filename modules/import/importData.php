...
class importData extends \yii\base\Module {
    ...
    public static function getLabels($l) {
        $label = [
            ...
            'staff-member' => ['import_class' => 'tbl_staff_member', 'table_name' => 'tbl_staff_member', 'fields' => 'union_code,ex_staff_member_code,staff_member_name,department,birth_date,blood_group_code,gender_code,qualification_code,caste_category_code,designation_code,branch_code,bank_account_no,mobile_no,email_id,tenure_from_date,payment_mode,address,pincode,pan_no,aadhar_card_no,hamlet_code', 'save_child' => true, 'scenario' => 'importCsv', 'default_fields' => 'originating_type:1,is_active:1', 'increment' => 1],
        ];
        return $label[$l];
    }
