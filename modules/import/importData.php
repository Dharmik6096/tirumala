...
class importData extends \yii\base\Module {
    ...
    public static function getLabels($l) {
        $label = [
            ...
            'bmc' => ['import_class' => 'bmc_import', 'table_name' => 'tbl_bmc', 'fields' => 'mcc_plant_code,bmc_code,bmc_type_code,bmc_name,local_name,model,capacity,manufacturer_code,bmc_milk_type,union_code,hamlet_code', 'default_fields' => 'is_active:1', 'scenario' => 'importCsv', 'mapping' => 1, 'mapping_model' => 'TblBmcMilkType', 'mapping_fields' => 'bmc_code,milk_type_code'],
            ...
            'milk-collection' => ['table_name' => 'tbl_milk_collection', 'fields' => 'bmc_code,dcs_code,member_code,date_time_of_collection,milk_type_code,shift_code,fat,snf,qty', 'default_fields' => 'is_active:1,originating_type:1', 'scenario' => 'importCsv'],
        ];
        return $label[$l];
    }
