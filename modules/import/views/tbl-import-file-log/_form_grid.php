    ...
    'response_msg',
        ...
        'value' => function($model) {
            if (!empty($model->error_file_path)) {
                ...
                return Html::a('<i class="fa fa-download"><i/>', str_replace('/web/web/', '/web/', $absoluteBaseUrl . $model->error_file_path), ['target' => '_blank']);
            }
        }],
        [
        ...
        'value' => function($model) {
            if (!empty($model->success_file_path)) {
                $absoluteBaseUrl = Url::base(true);
                return Html::a('<i class="fa fa-download"><i/>', str_replace('/web/web/', '/web/', $absoluteBaseUrl . $model->success_file_path), ['target' => '_blank']);
            }
        }],
];
$grid_option = [
