...
/* @var $model app\modules\welfarescheme\models\TblSchemeDocumentMasterSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="tbl-scheme-document-master-search">
    ...
    <?= $form->field($model, 'doc_group') ?>

    <?= $form->field($model, 'doc_name') ?>

    <?= $form->field($model, 'doc_ext') ?>
