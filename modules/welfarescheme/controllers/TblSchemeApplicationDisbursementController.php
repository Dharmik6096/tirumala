 ...
 */
class TblSchemeApplicationDisbursementController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $model = new TblSchemeApplicationDisbursement();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->disburse_id]);
        } else {
