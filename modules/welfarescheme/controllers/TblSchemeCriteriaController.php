 ...
 */
class TblSchemeCriteriaController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $model = new TblSchemeCriteria();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->scheme_criteria_id]);
        } else {
    ...
    /**
     * Deletes an existing TblSchemeCriteria model.
