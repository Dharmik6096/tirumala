...
/**
 * This is the model class for table "tbl_animal_treatment_request_history".
 *
 * @property integer $id
 ...
 */
class TblAnimalTreatmentRequestHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_animal_treatment_request_history';
    }
    ...
    public function rules() {
        return [
            [['animal_treatment_request_id', 'case_no', 'dcs_code', 'member_code', 'member_name', 'member_type', 'mobile_number', 'address', 'case_type_id', 'member_animal_tag_id', 'disease_id', 'animal_type_id', 'breed_id', 'gender_id', 'year', 'month', 'tran_datetime', 'created_at', 'created_by', 'updated_at', 'updated_by', 'originating_org_code', 'originating_org_type', 'originating_type', 'operation_type', 'history_created_at', 'history_created_by'], 'safe'],
        ];
    }
