                                ...
                                <div class="modal-body">
                                    ...
                                    foreach ($param as $key => $value) {
                                        ...
                                        if (in_array($value, array('p_sub_district_code'))) {
                                            ?>
                                            <div class="col-sm-4">
                                                <?php Yii::$app->dropdown->depend_dropdown('sub_district_code', $model, $form, 'reportsmodel-p_district_code', 'form-group col-sm-4 padding-right-5 padding-left-0', 'Sub District', 'p_sub_district_code'); ?>
                                            </div>    
                                            <?php
                                        }
                                        ...
                                        if (in_array($value, array('p_block_name'))) {
                                            ?>
                                            <div class="col-sm-4">
                                                <?php Yii::$app->dropdown->depend_dropdown('block_code', $model, $form, 'reportsmodel-p_sub_district_code', 'form-group col-sm-4 padding-right-5 padding-left-0', 'Block', 'p_block_name'); ?>
                                            </div>    
                                            <?php
                                        }
                                        ...
                                        if (isset($value_array[1]) && $value_array[1] == 'string') {
                                            ...
                                            <div class="col-sm-4">
                                                <?php
                                                echo Yii::$app->controls->date($model, $form, $value, 'form-group col-sm-4 padding-left-5 padding-right-5', false);
                                                ?>
                                            </div>    
                                            <?php
                                            if (isset($value_array[2])) {
                                                ...
                                                <div class="col-sm-4">
                                                    <?php
                                                    echo Yii::$app->dropdown->dropdown('shift_applicability', $model, $form, 'col-sm-4 form-group shift', $model->getAttributeLabel($value_array[2]), false, $value_array[2]);
                                                    ?>
                                                </div>    
                                                <?php
                                            }
                                        ...
                                        if (in_array($value, array('p_animal_type', 'p_milk_type', 'milk_type'))) {
                                            ...
                                            <div class="col-sm-4">
                                                <?php
                                                echo Yii::$app->dropdown->dropdown('milk_type_code', $model, $form, 'col-sm-4 form-group', $model->getAttributeLabel($value), false, $value, true);
                                                ?>
                                            </div>    
                                            <?php
                                        }
                                        if (in_array($value, array('p_member_code', 'member_code'))) {
                                            ...
                                            <div class="col-sm-4">
                                                <?php
                                                echo Yii::$app->dropdown->depend_dropdown('member', $model, $form, $depends, 'form-group col-sm-4 padding-right-5 padding-left-5', $model->getAttributeLabel($value), 'p_member_code');
                                                ?>
                                            </div>
                                        ...
                                        if (in_array($value, array('p_ltr_kg'))) {
                                            echo Yii::$app->dropdown->dropdownStatic('p_ltr_kg', $model, $form, 'col-sm-4 form-group', $model->getAttributeLabel($value), false, $value, false);
                                        }
