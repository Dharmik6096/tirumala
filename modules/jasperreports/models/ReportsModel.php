...
class ReportsModel extends Model {
    ...
    public $locale, $digit_config, $p_provisional_member_code, $p_lang_code, $p_lr_no, $p_vehicle_no, $p_mpp_survey_id, $p_VCG_M_Id, $p_vehicle_code, $trip_code, $p_login_type, $p_bank_type, $p_product_type, $p_receipt_sequence_no;
    ...
    public function rules() {
        return [
                [['locale', 'digit_config', 'p_provisional_member_code', 'p_language_code', 'p_lang_code', 'p_mpp_survey_id', 'p_VCG_M_Id', 'p_type', 'trip_code', 'p_vehicle_code', 'p_login_type', 'p_bank_type', 'p_product_type', 'p_plant_code', 'p_receipt_sequence_no'], 'safe'],
