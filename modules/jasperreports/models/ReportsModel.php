...
class ReportsModel extends Model {
    ...
    public function rules() {
        return [
            ...
            [['p_union_name', 'p_dcs_name', 'p_route_name', 'p_union_code', 'p_customer_type', 'p_customer_code', 'p_payment_cycle_code', 'p_member_code', 'p_staff_member_code', 'p_month', 'p_mcc_code', 'p_bmc_code'], 'safe'],
            ...
            [['union_code', 'p_plant_code', 'p_from_date', 'from_shift', 'p_to_date', 'to_shift'], 'required', 'on' => ['InchargeRemuneration']]
        ];
    }
