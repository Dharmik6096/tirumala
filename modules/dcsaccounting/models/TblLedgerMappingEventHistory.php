...
/**
 * This is the model class for table "tbl_ledger_mapping_event_history".
 *
 * @property integer $id
 ...
 */
class TblLedgerMappingEventHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_ledger_mapping_event_history';
    }
    ...
    public function attributeLabels() {
        return [
            ...
            'credit_ledger_code' => Yii::t('app', 'Credit Ledger Code'),
            'debit_ledger_code' => Yii::t('app', 'Debit Ledger Code'),
