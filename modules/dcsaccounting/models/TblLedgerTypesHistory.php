...
/**
 * This is the model class for table "tbl_ledger_types_history".
 *
 * @property integer $id
 ...
 */
class TblLedgerTypesHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_ledger_types_history';
    }
    ...
    public function attributeLabels() {
        return [
            ...
            'balance_sheet' => Yii::t('app', 'Balance Sheet'),
            'profit_loss' => Yii::t('app', 'Profit Loss'),
