...
/**
 * This is the model class for table "tbl_ledger_sub_ledgers_mapping".
 *
 ...
 */
class TblLedgerSubLedgersMapping extends \app\models\ChildModel {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_ledger_sub_ledgers_mapping';
    }
    ...
    public function rules() {
        return [
                ...
                [['ledger_sub_ledgers_mapping_code'], 'required'],
        ];
    }
