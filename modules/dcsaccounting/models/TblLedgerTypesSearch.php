...
class TblLedgerTypesSearch extends TblLedgerTypes {
    ...
    public function rules() {
        return [
                [['ledger_type_code', 'balance_sheet', 'profit_loss', 'is_active', 'originating_type', 'union_code', 'ledger_type_name', 'originating_org_code', 'originating_org_type', 'created_at', 'created_by', 'updated_at', 'updated_by', 'x_col1', 'x_col2', 'x_col3', 'x_col4', 'x_col5', 'ref_code'], 'safe'],
        ];
    }
    ...
    public function search($params) {
        ...
        $query->andFilterWhere(['like', 'tbl_ledger_types.ledger_type_name', $this->ledger_type_name])
                ...
                ->andFilterWhere(['like', 'tbl_ledger_types.ref_code', $this->ref_code]);
