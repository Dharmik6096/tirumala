...
$grid_option = [
    ...
    'actions' => [
        'edit' => function ($url, $model) {
            return GhostHtml::a('<i class="fa fa-pencil"></i>', Url::to(['tbl-financial-year/update', 'id' => $model->id]), ['data-toggle' => 'tooltip', 'data-placement' => 'top', 'data-original-title' => 'Edit']);
        },
    ]
];
