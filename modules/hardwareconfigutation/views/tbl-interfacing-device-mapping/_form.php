...
<div class="row">
    ...
    <div class="col-sm-2 create_fields">
        <?= Yii::$app->dropdown->union_plant($model, $form, 'tblinterfacingdevicemapping-union_code', 'plant_code', $model->getAttributeLabel('plant_code'), FALSE, ''); ?>
    </div>
    <div class="col-sm-2  create_fields">
        <?= Yii::$app->dropdown->plant_mcc($model, $form, 'tblinterfacingdevicemapping-plant_code', 'mcc_plant_code', $model->getAttributeLabel('mcc_plant_code'), FALSE, ''); ?>
    </div>  
    <div class="col-sm-2  create_fields">
        <?= Yii::$app->dropdown->mcc_bmc($model, $form, 'tblinterfacingdevicemapping-mcc_plant_code', 'bmc_code', Yii::t('app', 'BMC'), FALSE); ?>
    </div>  
    <div class="col-sm-2  create_fields">
        <?= Yii::$app->dropdown->bmc_society($model, $form, 'tblinterfacingdevicemapping-bmc_code', 'dcs_code', Yii::t('app', 'DCS')); ?>
    </div>
    <div class="col-sm-2  create_fields">
    ...
    <div class="col-sm-2  create_fields">
        <?= Html::hiddenInput('type_2', 5, ['id' => 'type_2']); ?>
    ...
    <div class="col-sm-2  create_fields">
        <?= Html::hiddenInput('type_3', 2, ['id' => 'type_3']); ?>
    ...
    <div class="col-sm-2  create_fields">
        <?= Html::hiddenInput('type_4', 1, ['id' => 'type_4']); ?>
