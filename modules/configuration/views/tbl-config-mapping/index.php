...
$this->params['menu'][] = GhostHtml::a('<i class="fa fa fa-plus"></i>' . Yii::t('app', 'Add Vendor Payment Config'), ['/configuration/tbl-config/payment-config-create', 'id' => $searchModel->union_code], ['class' => 'btn btn-danger btn-block']);
?>
