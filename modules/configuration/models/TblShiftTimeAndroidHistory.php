 ...
 */
class TblShiftTimeAndroidHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_shift_time_android_history';
    }
    ...
    public function rules() {
        return [
            ...
            [['created_at', 'created_by', 'updated_at', 'updated_by', 'originating_type', 'date_shift_enable', 'grace_hr', 'code', 'org_type'], 'safe'],
        ];
    }
