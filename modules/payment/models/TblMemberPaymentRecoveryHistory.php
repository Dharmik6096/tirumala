...
/**
 * This is the model class for table "tbl_member_payment_recovery_history".
 *
 * @property integer $id
 ...
 */
class TblMemberPaymentRecoveryHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_member_payment_recovery_history';
    }
    ...
    public function rules() {
        return [
            [['recovery_amount'], 'safe'],
            [['payment_cycle_code', 'from_shift', 'to_shift', 'originating_type'], 'safe'],
            ...
            [['for_member_code', 'from_member_code'], 'safe'],
