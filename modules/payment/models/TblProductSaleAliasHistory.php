...
/**
 * This is the model class for table "tbl_product_sale_alias_history".
 *
 * @property integer $id
 ...
 */
class TblProductSaleAliasHistory extends ChildModel {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_product_sale_alias_history';
    }
    ...
    public function rules() {
        return [
            [['product_sale_alias_code', 'action_perform', 'product_sale_code', 'ref_product_sale_code', 'customer_type', 'customer_code', 'error_desc', 'approved_at', 'approved_by', 'approval_status', 'created_at', 'created_by', 'updated_at', 'updated_by', 'originating_type', 'originating_org_code', 'originating_org_type', 'x_col1', 'x_col2', 'x_col3', 'x_col4', 'x_col5', 'operation_type', 'history_created_at', 'history_created_by'], 'safe'],
        ];
    }
