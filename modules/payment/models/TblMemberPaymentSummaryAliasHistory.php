...
class TblMemberPaymentSummaryAliasHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            [['payment_sumary_alias_code', 'member_count', 'payment_cycle_code', 'payment_cycle_applicabilty_code', 'from_datetime', 'to_datetime', 'from_shift', 'to_shift'], 'safe'],
            [['union_code', 'plant_code', 'mcc_plant_code', 'bmc_code', 'dcs_code', 'payment_status', 'created_by', 'updated_by'], 'safe'],
            [['qty', 'avg_fat', 'avg_snf', 'kg_fat', 'kg_snf', 'avg_rate', 'total_amount', 'total_deduction', 'final_amount', 'disburse_amount', 'adjust_recovery', 'recovery'], 'safe'],
