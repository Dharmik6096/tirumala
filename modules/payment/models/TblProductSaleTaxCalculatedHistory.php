...
/**
 * This is the model class for table "tbl_product_sale_tax_calculated_history".
 *
 * @property integer $id
 ...
 */
class TblProductSaleTaxCalculatedHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_product_sale_tax_calculated_history';
    }
    ...
    public function rules() {
        return [
                [['product_sale_tax_calculated_code', 'product_sale_code', 'product_sale_transaction_code', 'created_by', 'updated_by', 'history_created_by', 'operation_type', 'originating_org_code', 'originating_org_type', 'x_col1', 'x_col2', 'x_col3', 'x_col4', 'x_col5'], 'safe'],
