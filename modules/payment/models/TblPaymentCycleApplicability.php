...
class TblPaymentCycleApplicability extends \app\models\ChildModel {
    ...
    public function rules() {
        return [
                ...
                [['applicable_code'], 'validatePaymentCycle', 'skipOnEmpty' => false], //Comment as Set Validation from DB Side: Hardik //-> 21/02/2023 uncoment for add range conflict check due to issue in credit check in product sale : Seema
        ];
    }
