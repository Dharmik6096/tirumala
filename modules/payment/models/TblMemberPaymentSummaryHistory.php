...
/**
 * This is the model class for table "tbl_member_payment_summary_history".
 *
 * @property integer $id
 ...
 */
class TblMemberPaymentSummaryHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_member_payment_summary_history';
    }
    ...
    public function rules() {
        return [
                [['payment_sumary_code', 'member_count', 'payment_cycle_code', 'payment_cycle_applicabilty_code', 'from_datetime', 'to_datetime'], 'safe'],
