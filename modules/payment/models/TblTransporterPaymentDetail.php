...
class TblTransporterPaymentDetail extends \yii\db\ActiveRecord {
    ...
    public function getBmcCodeReturn() {
        return $this->hasOne(TblDcsBmc::className(), ['bmc_code' => 'return_dest']);
    }

    public function getMccPlantCodeReturn() {
        return $this->hasOne(TblMccPlant::className(), ['mcc_plant_code' => 'return_dest']);
    }

    public function getPlantCodeReturn() {
        return $this->hasOne(TblPlant::className(), ['plant_code' => 'return_dest']);
    }

    public function getCustomerCodeReturn() {
        return $this->hasOne(TblCustomerMaster::className(), ['customer_code' => 'return_dest']);
    }
