...
class TblMemberPaymentHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
                [['member_payment_code', 'payment_cycle_code', 'payment_cycle_applicabilty_code', 'is_verified', 'from_datetime', 'to_datetime', 'from_shift', 'to_shift', 'adjust_recovery', 'recovery'], 'safe'],
                ...
                [['disburse_date', 'payment_date', 'process_date', 'created_at', 'updated_at', 'total_addition', 'previous_hold', 'previous_due', 'hold_amount', 'net_payable', 'originating_org_code', 'originating_org_type', 'originating_type', 'member_name', 'beneficiary_name', 'dcs_name', 'hold_type', 'sync_status', 'sync_timestamp'], 'safe'],
        ];
    }
