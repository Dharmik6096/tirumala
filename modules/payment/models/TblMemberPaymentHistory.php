...
class TblMemberPaymentHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
                ...
                [['disburse_date', 'payment_date', 'process_date', 'created_at', 'updated_at', 'total_addition', 'previous_hold', 'previous_due', 'hold_amount', 'net_payable', 'originating_org_code', 'originating_org_type', 'originating_type', 'member_name', 'beneficiary_name', 'dcs_name', 'hold_type'], 'safe'],
        ];
    }
