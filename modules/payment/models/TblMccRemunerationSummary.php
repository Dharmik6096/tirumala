 ...
 */
class TblMccRemunerationSummary extends \app\models\ChildModel {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_mcc_remuneration_summary';
    }
...
//                }, 'skipOnError' => true, 'on' => 'processpayment'],
    ...
    public function attributeLabels() {
        return [
            'mcc_remuneration_summary_code' => Yii::t('app', 'Remuneration Summary Code'),
