...
$attribute = [
        ...
        'value' => function ($model, $key, $index) use ($form) {
            return '<span class=\'rtpl_validate\'>' . $form->field($model, '[' . $model->permanent_hold_amount_code . ']release_amount')->textInput(['value' => $model->hold_amount, 'class' => 'form-control number-validate release-amount',])->label(FALSE) . '</span>';
        }, 'filter' => false
    ],
        ['attribute' => 'hold_amount', 'contentOptions' => ['class' => 'pending-hold-amount'], 'filter' => false, 'label' => 'Pending Hold Amount', 'value' => function($model) {
            return 0;
        }],
        [
