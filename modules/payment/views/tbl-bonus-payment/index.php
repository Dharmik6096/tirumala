...
$this->params['menu'][] = Yii::$app->controls->custombutton('<i class="fa fa-money-bill"></i> ' . Yii::t('app', 'Disburse Bonus Payment (Member)'), ['/payment/tbl-bonus-payment/payment-disburse'], true);
?>
