...
$attribute = [
    ...
    ['attribute' => 'billing_based_on',
        'filter' => Yii::$app->dropdown->dropdownfilterStatic('billing_based_on', $searchModel, 'billing_based_on'),
        'value' => function($model) {
            return Yii::$app->general->getStaticValue($model->billing_based_on, 'billing_based_on');
        }
    ],
];

$grid_option = [
    'id' => 'vendor-payment-config-grid',
    'attributes' => $attribute,
    'active_column' => false,
    'actions' => [
        'delete' => ['option' => 'vsp_payment_config_code,vsp_payment_config_code,tbl-vsp-payment-config/delete'],
    ]
];
