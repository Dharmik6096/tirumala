...
$this->params['menu'][] =Yii::$app->controls->custombutton('Delete Product Sale', 'delete-product-sale', '', 'btn btn-danger btn-block', '<i class="fa fa-trash"></i>',['type'=>'vendorBulkDelete']);
$this->params['menu'][] = Yii::$app->controls->custombutton('Delete Product Sale To Member', 'delete-product-sale', '', 'btn btn-danger btn-block', '<i class="fa fa-trash"></i>',['type'=>'memberBulkDelete']);
