...
$this->params['menu'][] = Yii::$app->controls->custombutton('<i class="fa fa-money-bill"></i> ' . Yii::t('app', 'Reject Reinitiate'), ['/payment/tbl-payment-transaction/reject-reinitiate'], true);
