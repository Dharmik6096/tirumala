...
$this->params['menu'][] = Yii::$app->controls->custombutton('<i class="fa fa fa-moneybill"></i> ' . Yii::t('app', 'Disburse Remunaration Payment'), ['/payment/tbl-remuneration-summary/payment-disburse'], true);
$url = ['/payment/tbl-vsp-payment/vendor-payment-import'];
$this->params['menu'][] = Yii::$app->controls->import('vendor-billing-bulk', $this, Yii::t('app', 'Vendor Billing Import Data'), [], 'vendor', $url);
?>
