...
<div class="tbl-member-payment-index">
    <div class="panel panel-default panel-grid panel-main">
        ...
        <div class="panel-body">
            ...
            <?php
            echo $this->render('_disburse_form_grid_export', ['searchModel' => $searchModel, 'model' => $model, 'dataProvider' => $dataProvider, 'negativeValCount' => $negativeValCount,'bank_show' => $bank_show]);
            ?>
        </div>
    </div>
</div>