        ...
        $attribute = [
            ...
            ['attribute' => 'adjust_amount',
                ...
                'value' => function ($model, $key, $index) use ($form) {
                    return Html::activeHiddenInput($model, 'member_payment_code[' . $index . ']', ['value' => $model->member_payment_code]) . $form->field($model, 'adjust_amount[' . $index . ']')->textInput(['value' => $model->adjust_amount, 'class' => 'adjust-amount form-control',])->label(FALSE);
                },
                    ],
                    ['attribute' => 'net_amount',
                        ...
                        //  'pageSummary' => true,
                        'value' => function ($model, $key, $index) use ($form) {
                            return $form->field($model, 'net_amount[' . $index . ']')->textInput(['class' => 'net-amount form-control', "disabled" => TRUE])->label(FALSE);
                        },
                            ],
