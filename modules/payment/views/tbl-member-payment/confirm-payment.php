        ...
        <div class="panel-body">
            <div class="grid-search no-effect" >
                ...
                $form = ActiveForm::begin(['options' => [
                            ...
                            'action' => Url::to(['disburse-payment'])
                ]);
                ?>   
                ...
                $attribute = [
                    ...
                    return ['disabled' => $disabled, 'class' => 'checkbox', 'value' => $model['member_code']];
                }],
                ...
                <div class="col-md-12" >    
                    <?= Html::button(Yii::t('app', 'Member Payment'), ['class' => 'btn btn-primary disburse', 'name' => 'member']); ?>
