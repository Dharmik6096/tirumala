...
//                'action' => ['get-temp-data'],
    ...
    <div class="col-sm-2">
        <?= Yii::$app->dropdown->union_plant($model, $form, 'tblproductsalelockingsearch-union_code', 'plant_code', $model->getAttributeLabel('plant_code'), FALSE, ''); ?>
    </div>
    <div class="col-sm-2 ">
        <?= Yii::$app->dropdown->plant_mcc($model, $form, 'tblproductsalelockingsearch-plant_code', 'mcc_plant_code', $model->getAttributeLabel('mcc_plant_code'), FALSE, ''); ?>
    </div>  
    <div class="col-sm-2 ">
        <?= Yii::$app->dropdown->mcc_bmc($model, $form, 'tblproductsalelockingsearch-mcc_plant_code', 'bmc_code', Yii::t('app', 'BMC'), FALSE); ?>
    </div>  
    ...
    <div class="col-sm-2">
        <?= Yii::$app->dropdown->dropdownStatic('master_type', $model, $form, 'form-group', $model->getAttributeLabel('type'), false, 'type', false); ?>
    </div>
