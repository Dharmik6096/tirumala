...
$this->params['menu'][] = Yii::$app->controls->custombutton('<i class="fa fa fa-money-bill"></i> ' . Yii::t('app', 'Disburse Vendor Payment Hold Release'), ['/payment/tbl-vendor-payment-hold-release/payment-disburse'], true);
?>
