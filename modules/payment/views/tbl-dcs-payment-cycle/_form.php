...
<?php
$script = "
            $('#tbldcspaymentcycle-interval_value').on('blur',function(e){           
...
";
$script.=" $('#tbldcspaymentcycle-interval_value').on('keyup',function(e){           
                   if(jQuery.inArray($(this).val(), ['5','10','15']) != -1)
                       $('.field-tbldcspaymentcycle-check_month').show(); 
                   else
                        $('.field-tbldcspaymentcycle-check_month').hide(); 
            });";
$this->registerJs($script, View::POS_END, 'check-month');
?>
