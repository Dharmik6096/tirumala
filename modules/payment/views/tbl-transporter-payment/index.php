...
$this->params['menu'][] = GhostHtml::a('<i class="fa fa-money"></i>' . Yii::t('app', 'Disburse Transporter Payment'), ['/payment/tbl-transporter-payment/disburse-payment'], ['class' => 'btn btn-danger btn-block']);
?>
