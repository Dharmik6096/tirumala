...
<div class="no-effect" >
    ...
    <div class="grid-button-wrap" >
        ...
        if (is_array($model->mcc_plant_code)) {
            ?>
            <?php foreach ($model->mcc_plant_code as $mcc_code) { ?>
                <?= Html::activeHiddenInput($model, 'mcc_plant_code[]', ['value' => $mcc_code]); ?>
            <?php } ?>
        <?php } else { ?>
...
$script = "
        ...
        $('form#mcc-payment-disburse').submit();
    });
