...
$this->params['menu'][] = Yii::$app->controls->custombutton('<i class="fa fa fa-money-bill"></i> ' . Yii::t('app', 'Disburse MCC Payment'), ['/payment/tbl-mcc-remuneration-summary/payment-disburse'], true);
?>
