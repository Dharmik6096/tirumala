...
$society_name = !empty($dataProvider->getModels()) ?
        Yii::$app->general->getforeignkey($model->bmcCode, 'bmc_name') . ' (' .
        Yii::$app->general->getforeignkey($model->bmcCode, 'ref_code') . ')' : '';
$update_count = 0;
?>
        ...
        <div class="modal-content">
            ...
            <div class="popup-header bg_white">
                ...
                $form = ActiveForm::begin(['options' => [
                            ...
                            'action' => Url::to(['/payment/tbl-mcc-payment/bill-head', 'code' => $model->mcc_payment_code])
                ]);
                ?>
