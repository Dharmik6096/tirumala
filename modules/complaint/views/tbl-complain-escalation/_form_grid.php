    ...
    'actions' => [
        ...
        'deactive' => function ($url, $model) {
            ...
            if ($model->is_active == 1) {
                $options = ['data-bs-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Deactivate', 'class' => 'deact-escalation', 'data-val' => $model->complain_escalation_code, 'data-name' => $name];
                return GhostHtml::a_alert('<i class="fa fa-times"></i>', ['/complaint/tbl-complain-escalation/deactivate-escalation'], $options);
            } else {
                $options = ['data-bs-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Activate', 'class' => 'react-escalation', 'data-val' => $model->complain_escalation_code, 'data-name' => $name];
