...
//            'query' => TblMccBillHeadCriteriaSlabs::find()->where(['criteria_code' => $id]),
//            'pagination' => FALSE,
//        ]);
    ...
    public function actionListGrid() {
        $searchModel = new TblMccBillHeadCriteriaSlabsSearch();
        echo '<pre>';
        print_r(Yii::$app->request->post('TblMccBillHeadCriteriaSlabs'));
        die;
        $searchModel->setAttributes(Yii::$app->request->get('TblMccBillHeadCriteriaSlabs'));
        $dataProvider = $searchModel->createsearch([]);
          $dataProvider = new ActiveDataProvider([
            'query' => TblMccBillHeadCriteriaSlabs::find()->where(['criteria_code' => $id]),
            'pagination' => FALSE,
