...
use app\modules\vsp\models\TblGeneralFormulaSearch;
...
use app\modules\vsp\models\TblGeneralFormulaHistory;
/**
 * TblGeneralFormulaController implements the CRUD actions for TblGeneralFormula model.
 */
class TblGeneralFormulaController extends \app\controllers\ChildController {
    ...
    public function actionIndex() {
        $searchModel = new TblGeneralFormulaSearch();
    ...
    public function actionCreate() {
        $this->model = new TblGeneralFormula();
    ...
    public function actionUpdate($id) {
        ...
        $keyword_data = $keyword_model->getKeywordData();
        if (Yii::$app->request->post()) {
            $historyModel = new TblGeneralFormulaHistory();
    ...
    protected function findModel($id) {
        if (($model = TblGeneralFormula::findOne($id)) !== null) {
            return $model;
        } else {
