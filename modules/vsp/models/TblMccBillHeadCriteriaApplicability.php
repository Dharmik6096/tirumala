...
/**
 * This is the model class for table "tbl_mcc_bill_head_criteria_applicability".
 *
 ...
 */
class TblMccBillHeadCriteriaApplicability extends \app\models\ChildModel {

    public $criteria_applicabilty_code;
    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_mcc_bill_head_criteria_applicability';
    }
    ...
    public function rules() {
        return [
            [['created_at', 'updated_at', 'from_date', 'to_date'], 'safe'],
            [['from_date','to_date', 'applicable_code'], 'required','except' =>['updateToDate']],
    ...
    public function attributeLabels() {
        return [
            'criteria_applicabilty_code' => Yii::t('app', 'Bill Head Criteria Applicabilty Code'),
    ...
    public function getEditRecord() {
        return $this->find()->where(['criteria_code' => $this->criteria_code, 'applicable_code' => $this->applicable_code, 'applicable_for' => $this->applicable_for])
