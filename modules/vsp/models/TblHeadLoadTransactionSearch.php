...
/**
 * TblHeadLoadTransactionSearch represents the model behind the search form about `app\modules\vsp\models\TblHeadLoadTransaction`.
 */
class TblHeadLoadTransactionSearch extends TblHeadLoadTransaction {
    ...
    public function rules() {
        return [
                // [['head_load_transaction_code', 'from_km', 'from_qty', 'to_km', 'to_qty', 'value', 'created_at',  'flg_sentbox_entry', 'sync_status', 'sync_timestamp', 'updated_at', 'created_by',  'head_load_code', 'updated_by'], 'safe'],
