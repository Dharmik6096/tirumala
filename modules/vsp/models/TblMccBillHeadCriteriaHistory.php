 ...
 */
class TblMccBillHeadCriteriaHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_mcc_bill_head_criteria_history';
    }
    ...
    public function rules() {
        return [
                ...
                [['created_at', 'updated_at', 'history_created_at', 'criteria_code'], 'safe'],
