 ...
 */
class TblVspBillHeadCriteriaSlabs extends \app\models\ChildModel {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_vsp_bill_head_criteria_slabs';
    }
    ...
    public function rules() {
        return [
            ...
            [['vsp_slab_code', 'vsp_criteria_code', 'general_formula_code', 'for_what'], 'string', 'max' => 20],
    ...
    public function validateRange($attribute, $params) {
        ...
        $dateData = $this->find()
                ->where('vsp_criteria_code = \'' . $this->vsp_criteria_code . '\'')
                ...
                ->andfilterWhere(['!=', 'vsp_slab_code', $this->vsp_slab_code])
                ->all();
        if (!empty($dateData)) {
