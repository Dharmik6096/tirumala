...
/**
 * This is the model class for table "tbl_mcc_bill_head_criteria_applicability_history".
 *
 * @property integer $id
 ...
 */
class TblMccBillHeadCriteriaApplicabilityHistory extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_mcc_bill_head_criteria_applicability_history';
    }
    ...
    {
        return [
            [['criteria_applicability_code','criteria_code', 'originating_type'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'criteria_applicabilty_code' => 'Mcc Bill Head Criteria Applicabilty Code',
