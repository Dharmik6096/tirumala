...
use app\modules\vsp\models\TblBillHeadTransactionInstallment;
use app\modules\dcsoperation\models\TblMember;

/**
 * This is the model class for table "tbl_bill_head_transaction".
 *
 ...
 */
class TblBillHeadTransaction extends \app\models\ChildModel {

    /**
     * @inheritdoc
     */
    public $customer_name, $installment_start_date, $ex_code, $member_code;

    public static function tableName() {
        return 'tbl_bill_head_transaction';
    }
    ...
    public function rules() {
        return [
                ...
                [['no_installment', 'originating_type'], 'integer'],
    ...
    public function attributeLabels() {
        return [
            ...
            'no_installment' => Yii::t('app', 'No. of Installment'),
    ...
    public function getData($dcs_code, $payment_cycle_code, $bill_head_code) {
        return $this->find()->select(['bill_head_code', 'amount', 'bill_head_detail_code'])->where(['dcs_code' => $dcs_code, 'bill_head_code' => $bill_head_code])->asArray()->all();
    }
    ...
    public function getInstallmentCode() {
        return $this->hasOne(TblBillHeadTransactionInstallment::className(), ['bill_head_txn_code' => 'bill_head_txn_code']);
    }
    ...
    public function setAutoData($attribute, $params) {
        if (empty($this->getErrors())) {
            ...
            $this->payment_cycle_type = $billHead->payment_cycle_type;
            $no = !empty($this->no_installment) ? ($this->no_installment) : 1;
            $this->unpaid_amount = $this->amount;
            $this->installment_amount = $this->amount / $no;
        }
    }
