 ...
 * @property integer $mcc_bill_head_detail_code
 ...
 */
class TblMccBillHeadInstallment extends \app\models\ChildModel {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_mcc_bill_head_installment';
    }
    ...
    public function rules() {
        return [
                [['mcc_bill_head_detail_code'], 'integer'],
                [['mcc_bill_head_code', 'bmc_code', 'installement_cycle', 'installment_amount'], 'safe'],
                ...
                [['mcc_bill_head_code'], 'setHeadDetail']
        ];
    }
    ...
    public function attributeLabels() {
        return [
            ...
            'mcc_bill_head_detail_code' => 'Bill Head Detail Code',
            'mcc_bill_head_code' => 'Bill Head Code',
            'bmc_code' => 'BMC Code',
    ...
    public function getData($detail_id) {
        return $this->find()->select(['bill_head_installment_code'])->where(['mcc_bill_head_detail_code' => $detail_id])->all();
    }
