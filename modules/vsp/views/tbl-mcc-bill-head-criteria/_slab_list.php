    ...
    $grid_option = [
        ...
        'actions' => [
            'delete-slab' => function($url, $model) {
                $options = ['data-bs-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Delete', 'class' => 'delete-slab', 'data-from' => $model->from_val, 'data-to' => $model->to_val, 'data-id' => $model->criteria_slab_code];
