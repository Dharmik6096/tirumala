...
$form = ActiveForm::begin([
            'options' => ['id' => 'mcc-bill-head-criteria-form'],
...
<div class="row table_form theme-box theme_border_right theme_border_left theme_border_bottom">
    <div class="col-sm-12 padding_10_0 DisableAferAdd">
        <div class="col-sm-12 col-md-12 padding_left_0 padding_right_0 clearfix">
            <h4 class="theme-box-heading">Mcc Bill Head Criteria</h4>
        </div>
        ...
        <div class="col-sm-2 <?= $disable ?>">
            <?= Yii::$app->dropdown->dropdown('mcc_bill_head', $model, $form, '', TRUE, FALSE, 'mcc_bill_head_code'); ?>
        </div>
        <div class="col-sm-2 <?= $disable ?>">
            <?= Yii::$app->dropdown->depend_dropdown('mcc_general_formula_code', $model, $form, 'tblmccbillheadcriteria-union_code', '', $model->getAttributeLabel('general_formula_code')); ?>
         </div>
    ...
    <div class="col-md-10 padding_10_0 theme-box view-subtitle QltyParamDiv">
        ...
        <div class="col-sm-2">
            <?= Yii::$app->dropdown->depend_dropdown('mcc_general_formula_code', $txModel, $form, 'tblmccbillheadcriteria-union_code', '', $model->getAttributeLabel('general_formula_code'), 'general_formula_code', TRUE); ?>
        </div>       
...
//                                                                    $(".create_fields select").prop("disabled", true);                                                                  
                                                                    ...
                                                                    $("#mcc-bill-head-criteria-form .reset_field select").val("");
                                                                    $("#mcc-bill-head-criteria-form .reset_field textarea").val("");
                                                                   ...
                                                                   setTimeout(function(){
                                                                    $("#tblmccbillheadcriteria-criteria_code").val(data.pk_code);
                                                                     reloadGrid();
                                                                    $("#tblmccbillheadcriteriaslabs-from_val").focus();},100);
                                                                    });
                                                                }else{
                                                                    $("#loadercontent").hide();
                                                                    $("#pageloader").hide();
