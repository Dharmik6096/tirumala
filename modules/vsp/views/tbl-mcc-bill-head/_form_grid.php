...
$attribute = [
    ['attribute' => 'union_code', 'value' => function($model) {
        ...
        'filter' => false,],
    ['attribute' => 'mcc_bill_head_code', 'visible' => false],
...
$grid_option = [
    ...
    'actions' => [
        'edit' => function ($url, $model) {
            ...
            return GhostHtml::a('<i class="fa fa-pencil-alt"></i>', ['/vsp/tbl-mcc-bill-head/update', 'id' => $model->mcc_bill_head_code], $options);
        },
        'mapping' => function ($url, $model) {
            ...
            return GhostHtml::a('<i class="fa fa-plus"></i>', ['/vsp/tbl-mcc-bill-head/bill-head-applicability', 'id' => $model->mcc_bill_head_code], $options);
        },
    ]
];
