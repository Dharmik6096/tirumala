...
class TblIndentMasterHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
                [['indent_code'], 'safe'],
                [['union_code', 'mcc_plant_code', 'plant_code', 'dcs_code', 'bmc_code', 'customer_type', 'customer_code', 'member_code', 'product_code', 'status', 'indent_date', 'qty', 'status_remarks', 'approve_qty', 'rejected_qty', 'approve_remarks', 'received_qty'], 'safe'],
