...
class TblProductSearch extends TblProduct {
    ...
    public function search($params) {
        ...
        $query->joinWith(['unionCode', 'plantCode', 'mccPlantCode', 'bmcCode', 'dcsCode', 'unitCode', 'productGroupCode', 'taxCode', 'purchaseLedgerCode as purchase_led', 'saleLedgerCode as sale_led', 'stateTaxCode as state_tax', 'localSaleLedgerCode as local_sale_led', 'stockLedgerCode as stock_led']);
        if (!$this->validate()) {
