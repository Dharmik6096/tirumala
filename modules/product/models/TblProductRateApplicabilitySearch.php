...
class TblProductRateApplicabilitySearch extends TblProductRateApplicability {
    ...
    public function rules() {
        return [
                ...
                [['wef_date', 'product_sale_rate_code', 'dcs_code', 'union_code', 'created_at', 'created_by', 'updated_at', 'updated_by', 'mcc_plant_code', 'applicable_code', 'applicable_for', 'applicable_type', 'originating_org_code', 'originating_org_type'], 'safe'],
                [['sale_rate', 'name', 'code_ex'], 'safe'],
        ];
    }
