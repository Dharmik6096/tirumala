...
class TblGrnTxn extends \app\models\ChildModel {
    ...
    public function rules() {
        return [
            ...
            [['grn_txn_code', 'sap_batch_no', 'dispatch_qty', 'missing_qty', 'rejection_remarks', 'missing_remarks', 'is_stock_posted', 'plant_dispatch_txn_code','data_post_status','pick_datetime', 'response_datetime','response_msg'], 'safe'],
