...
/**
 * This is the model class for table "tbl_plant_dispatch_history".
 *
 * @property integer $id
 ...
 */
class TblPlantDispatchHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_plant_dispatch_history';
    }
    ...
    public function rules() {
        return [
            [['dispatch_date', 'document_date', 'created_at', 'updated_at', 'remarks', 'vendor_master_code'], 'safe'],
