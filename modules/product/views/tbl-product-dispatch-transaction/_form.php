...
<div class="row">
    ...
    <?= $form->field($model, 'dispatch_qty', ['options' => ['class' => 'form-group col-sm-2 number-validate']])->textInput() ?>
    <?= $form->field($model, 'rate', ['options' => ['class' => 'form-group col-sm-2']])->textInput(['readonly' => true]) ?>
    <?= $form->field($model, 'amount', ['options' => ['class' => 'form-group col-sm-2']])->textInput(['readonly' => true]) ?>
    <?= $form->field($model, 'discount_amount', ['options' => ['class' => 'form-group col-sm-2 number-validate']])->textInput([]) ?>
