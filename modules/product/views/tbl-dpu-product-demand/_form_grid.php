...
$attribute = [
    ...
    ['attribute' => 'product_name', 'value' => function($model) { return Yii::$app->general->getforeignkey($model->productCode, 'product_name'); }, 'filter'=>false],
    ['attribute' => 'PPrice', 'visible' => false, 'filter'=>false],
    ['attribute' => 'PQty', 'visible' => false, 'filter'=>false],
