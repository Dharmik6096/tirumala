...
class TblDcsSearch extends TblDcs {
    ...
    public function rules() {
        return [
                ...
                [['f_union_code', 'f_plant_code', 'f_mcc_code', 'f_bmc_code'], 'required', 'on' => ['dpuPassword', 'listSearch']],
                ...
                [['smart_master_type'], 'required', 'on' => ['listSearch']],
        ];
    }
...
//                ->andFilterWhere(['like', 'tbl_dcs.mobile_no', $this->mobile_no])
    ...
    public function searchrepush($params) {
        ...
        $query->andFilterWhere(['like', 'data_post_status', $this->data_post_status]);
