...
use Yii;
use app\modules\organisation\models\TblTransporter;
...
class TransporterImport extends TblTransporter
{
               ...
               if($vilage['msg']!=''){
                    ...
                    if($subDistricts['msg']!=''){
                        ...
                        if($districts['msg']!=''){
                            ...
                            if(empty($this->union_code)){return false;}
