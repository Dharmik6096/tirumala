...
class TblDcsBmcHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
                [['created_at', 'created_by', 'updated_by', 'operation_type', 'history_created_at', 'updated_at', 'is_active', 'is_mcc', 'valid_from', 'sap_vendor_code', 'password', 'gst_no', 'pan_no', 'is_rented_bmc', 'fssi'], 'safe'],
