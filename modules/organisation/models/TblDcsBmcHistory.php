...
class TblDcsBmcHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
                ...
                [['mcc_plant_code', 'originating_org_type', 'originating_org_code', 'originating_type', 'address', 'aadhaar_no', 'pincode', 'subcenter_code', 'emilk_sync_status', 'emilk_sync_timestamp'], 'safe'],
        ];
    }
