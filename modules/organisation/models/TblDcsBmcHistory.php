...
class TblDcsBmcHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            [['created_at', 'created_by', 'updated_by', 'operation_type', 'history_created_at', 'updated_at', 'is_active', 'is_mcc', 'valid_from', 'sap_vendor_code', 'password', 'gst_no', 'pan_no', 'is_rented_bmc', 'fssi', 'fssi_expiry_date'], 'safe'],
            ...
            [['bmc_code_ex', 'ref_code', 'vendor_code', 'auto_code', 'rate_calculate_on_merge', 'billing_type', 'antibiotic_check'], 'safe'],
            [['data_post_id', 'data_post_status', 'picked_datetime', 'resp_status', 'resp_desc', 'response_datetime', 'history_created_by'], 'safe'],
            [['mcc_plant_code', 'originating_org_type', 'originating_org_code', 'originating_type', 'address', 'aadhaar_no', 'pincode', 'subcenter_code', 'bmc_short_name', 'emilk_sync_status', 'emilk_sync_timestamp'], 'safe'],
        ];
    }
