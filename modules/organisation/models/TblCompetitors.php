 ...
 */
class TblCompetitors extends \app\models\ChildModel {
    ...
    public function rules() {
        return [
            [['created_at', 'updated_at', 'competitor_name', 'originating_type', 'created_by', 'updated_by', 'originating_org_code', 'originating_org_type'], 'safe'],
        ];
    }
