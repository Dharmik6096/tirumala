    ...
    public function rules() {
        return [
            // [['id'], 'required'],
                ...
                [['data_post_id', 'data_post_status', 'picked_datetime', 'resp_status', 'resp_desc', 'response_datetime', 'history_created_by', 'sap_route_code'], 'safe'],
                [['originating_org_code', 'originating_org_type', 'originating_type', 'vehicle_code', 'transporter_code', 'morning_grace_time', 'evening_grace_time', 'emilk_sync_status', 'emilk_sync_timestamp'], 'safe']
        ];
    }
