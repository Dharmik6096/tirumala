...
class TblUnionsHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
                ...
                [['originating_org_code', 'originating_org_type', 'originating_type', 'x_col1', 'x_col2', 'x_col3', 'x_col4', 'x_col5', 'allow_member_create', 'history_created_by', 'emilk_sync_status', 'emilk_sync_timestamp'], 'safe'],
        ];
    }
