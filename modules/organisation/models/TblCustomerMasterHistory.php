...
class TblCustomerMasterHistory extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
                ...
                [['customer_code', 'customer_name', 'address', 'state_code', 'district_code', 'sub_district_code', 'village_code', 'hamlet_code', 'local_name', 'local_address', 'gst_no', 'union_code', 'created_by', 'updated_by', 'operation_type', 'history_created_by', 'customer_type', 'sap_code', 'refference_code', 'x_col1', 'x_col2', 'x_col3', 'x_col4', 'x_col5', 'originating_org_code', 'originating_org_type', 'is_weight_manual', 'is_quality_manual'], 'safe'],
