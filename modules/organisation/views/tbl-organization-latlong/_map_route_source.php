    ...
    <div class="panel-body">
        ...
        <div class="row theme_border_left theme_border_right theme_border_bottom">
            <div class="col-md-12 padding_10_0 theme-box ">
                ...
                <?php echo Html::activeHiddenInput($model, 'user_code', ['value' => $model->user_code]) ?>
                <?php echo Html::activeHiddenInput($model, 'union_code', ['value' => $model->union_code]) ?>
...
//                exit;
                    ...
                    <div class="col-sm-12">
                        <?php
                        echo $form->field($model, 'applicable_code')->checkboxList(
                                $destinations, [
                            'id' => 'routes-list',
                            'class' => 'row mb15',
                            'item' =>
                            function ($index, $label, $name, $checked, $value) use ($selected, $defaultValue, $model) {
                                $checked = in_array($value, $selected);
                                $model->applicable_code = Yii::$app->getRequest()->getQueryParam('id');
