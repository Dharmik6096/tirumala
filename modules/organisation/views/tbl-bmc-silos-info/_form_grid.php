    ...
    $grid_option = [
        ...
        'actions' => [
            'edit' => function ($url, $model) {
                $options = ['data-bs-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Edit', 'class' => 'edit-record', 'data-val' => $model->bmc_silos_info_code, 'data-name' => $model->bmc_silos_info_code, 'title' => Yii::t('app', 'Edit')];
