...
//        },
        ...
        'value' => function($model) {
            return Yii::$app->controls->view_datetime($model->from_datetime);
        }, 'visible' => FALSE],
        ['attribute' => 'to_datetime',
        'value' => function($model) {
            return Yii::$app->controls->view_datetime($model->to_datetime);
        }, 'visible' => FALSE],
        [
        'attribute' => 'update_transaction',
        'value' => function($model) {
            return Yii::$app->general->getStaticDropdownVal('boolean_value', $model, 'update_transaction');
        }, 'visible' => FALSE],
];
