...
if (Yii::$app->general->checkAccess('/organisation/tbl-dcs/update')) {
    ...
    $this->params['menu'][] = Yii::$app->controls->custombutton('<i class="fa fa-check"></i> ' . Yii::t('app', 'Society Provisional Approvals'), ['/organisation/tbl-dcs-provisional/dcs-provisional-approval'], true);
