...
$this->params['menu'][] = GhostHtml::a(Yii::t('app', '<i class="fa fa-user-circle-o"></i> Contact Details'), ['/organisation/tbl-federations/contact-details', 'id' => $model->federation_code], ['class' => 'btn btn-danger btn-block']);
?>
