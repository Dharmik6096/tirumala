...
$this->params['menu'][] = GhostHtml::a('<i class="fa fa fa-times"></i>' . Yii::t('app', 'Customer Deactivation'), ['/organisation/tbl-customer-deactive/index'], ['class' => 'btn btn-danger btn-block']);
?>
