...
<div class="row theme_border_left theme_border_right theme_border_bottom">
    ...
    <div class="row">
        <div class="col-sm-12 margin-top-10 shortcut-main" shortcut="true" display_shortcut="false" hilight_shortcut="false">
            <div class="form-group">
                ...
                <?= Html::submitButton($type == 'create' ? Yii::t('app', 'NEXT') : ($createSapErrorData ? Yii::t('app', 'UPDATE & CREATE') : Yii::t('app', 'Update')), ['class' => 'btn-login btn btn-primary apply-shortcut saveBtn', 'name' => 'submitBtn', 'value' => 'save']) ?>
    ...
    $('#tblcustomermasterprovisional-customer_type').on('change', function(){
    $('#tblcustomermasterprovisional-prefix').val('');
        PreffixValue();
    });
    $(document).on('change', '#tblcustomermasterprovisional-union_code', function() {  
    $('#tblcustomermasterprovisional-prefix').val('');
        PreffixValue();
    });

    function PreffixValue(){
        var union = $('#tblcustomermasterprovisional-union_code').val();
        var type = $('#tblcustomermasterprovisional-customer_type').val();
            if(union !='' && type !=''){
                $.ajax({
                    type: 'post',
                    ...
                    success: function(data) {                                        
                        ...
                        console.log(obj.data);
                          $('#tblcustomermasterprovisional-prefix').val(obj.data);
                        }
                    },
                    error:function(data){
