...
<div class="panel panel-default panel-main hide-grid-settings">
    <div class="panel-heading">
        <ul class="progressbar">
            <li class="inactive"><?= Yii::t('app', 'customer_code') ?> Provisional No. <?= $model->customer_provisional_code ?>  > </li>
                    ...
                    <div class="col-sm-12 shortcut-main mt10" shortcut="true" display_shortcut="false" hilight_shortcut="false">
                        <div class="form-group">
                            ...
                            AjaxSubmitButton::begin([
                                ...
                                'ajaxOptions' => [
                                    'type' => 'POST',
                                    'url' => Url::to(['document-upload', 'id' => $model->customer_provisional_code]),
                                    'processData' => false,
                                    'contentType' => false,
