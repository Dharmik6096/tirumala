            ...
            <div class="">
                ...
                <div class="row margin_0">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-sm-4">
                            <?= Yii::$app->dropdown->union_plant($model, $form, 'tblcompetitorsapplicability-union_code', 'plant_code'); ?>
                        </div>


                        <div class="col-sm-4">
                            <?= Yii::$app->dropdown->plant_mcc($model, $form, 'tblcompetitorsapplicability-plant_code', 'mcc_plant_code'); ?>
                        </div>


                        <div class="col-sm-4">
                            <?= Yii::$app->dropdown->mcc_bmc($model, $form, 'tblcompetitorsapplicability-mcc_plant_code', 'bmc_code'); ?>
                        </div>
                    </div>
