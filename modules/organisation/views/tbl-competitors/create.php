                                ...
                                <div class="col-sm-4 set_overflow">
                                    <div class="whole_border">
                                        <div class="col-sm-12 col-md-12 padding_10_0 theme-box padding_left_0 padding_right_0 margin-bottom-10 clearfix">
                                            <h4 class="theme-box-heading"><?= Yii::t('app', 'Societies') ?></h4>
                                        </div>
                                        <table class="table table-bordered table-striped table-main table-language table-rate">
                                            <thead>
                                                <tr>
                                                    <th width='17%' height='25' class='center-align center_text'>
                                                        <?= Html::checkbox('allowCashCheckAll', false, ['id' => 'allowCashCheckAll', 'class' => 'checkbox checkboxHeight', 'label' => '']) ?></th>
                                                ...
                                                <?php for ($i = 0; $i < $first_table; $i++) {
                                                    ...
                                                    <tr>
                                                        <td class='center-align center_text'>
                                                            <?= $form->field($saveModel[$i], '[' . $i . ']customer_code')->checkbox(['checked' => isset($existData[$model[$i]->dcs_code]), 'class' => 'allow-cash-checkbox checkboxHeight', 'value' => $model[$i]->dcs_code], false)->label(false); ?></td>
                                                        <td><?= $model[$i]->dcs_name . '(' . $model[$i]->dcs_code_ex . ')'; ?></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                ...
                                                for ($i = $first_table; $i < $second_table; $i++) {
                                                    if (isset($model[$i])) {
                                                        ?>
                                                        <tr>
                                                            <td class='center-align center_text'><?= $form->field($saveModel[$i], '[' . $i . ']customer_code')->checkbox(['checked' => isset($existData[$model[$i]->dcs_code]), 'class' => 'allow-cash-checkbox checkboxHeight', 'value' => $model[$i]->dcs_code], false)->label(false); ?></td>
                                                            <td><?= $model[$i]->dcs_name . '(' . $model[$i]->dcs_code_ex . ')'; ?></td>
                                                        </tr>
                                                        <?php
                                                    }
