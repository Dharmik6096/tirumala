...
<div class="row">
    <div class="col-sm-8">
        <div class="row">
            ...
            <div class="col-sm-3">
                <?php Yii::$app->dropdown->depend_dropdown('sub_district_code', $model, $form, 'tblbranch-district_code', 'form-group padding-right-5 col-sm-3', 'Sub District'); ?>
            </div>
            <div class="col-sm-3">
                <?php Yii::$app->dropdown->depend_dropdown('village_code', $model, $form, 'tblbranch-sub_district_code', 'form-group padding-right-5 col-sm-3', 'Village'); ?>
            </div>
            <div class="col-sm-3">
