...
<div class="row">
    ...
    <div class="col-sm-2">
        <?= Yii::$app->dropdown->union_plant($model, $form, 'tblcustomerdeactive-union_code', 'plant_code', $model->getAttributeLabel('plant_code'), false, ''); ?>  
    </div>
    <div class="col-sm-2">
        <?= Yii::$app->dropdown->plant_mcc($model, $form, 'tblcustomerdeactive-plant_code', 'mcc_plant_code', $model->getAttributeLabel('mcc_plant_code'), false, ''); ?>
    </div>
    <div class="col-sm-2">
        <?= Yii::$app->dropdown->mcc_bmc($model, $form, 'tblcustomerdeactive-mcc_plant_code', 'bmc_code', $model->getAttributeLabel('bmc_code'), false, '', ''); ?>
    </div>
    <div class="col-sm-2">
