...
$this->params['menu'][] = GhostHtml::a(Yii::t('app', '<i class="fa fa-user-circle-o"></i> Contact Details'), ['/organisation/tbl-cluster/contact-details', 'id' => $model->cluster_code], ['class' => 'btn btn-danger btn-block']);
?>
