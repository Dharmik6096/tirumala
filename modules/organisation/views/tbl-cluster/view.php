...
$this->title = Yii::$app->label->title('view', 'Cluster');
$this->params['menu'][] = Yii::$app->controls->update($model->cluster_code);
$this->params['menu'][] = GhostHtml::a(Yii::t('app', '<i class="fa fas fa-user-circle"></i> Contact Details'), ['/organisation/tbl-cluster/contact-details', 'id' => $model->cluster_code], ['class' => 'btn btn-danger btn-block']);
?>
