...
$this->params['menu'][] = GhostHtml::a(Yii::t('app', '<i class="fa fas fa-user-circle"></i> Contact Details'), ['/organisation/tbl-dcs-bmc/contact-details', 'id' => $model->bmc_code], ['class' => 'btn btn-danger btn-block']);
?>
