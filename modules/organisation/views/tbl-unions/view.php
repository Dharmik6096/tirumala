...
$this->params['menu'][] = GhostHtml::a('<i class="fa fa fa-cog"></i>' . Yii::t('app', 'Control Mapping'), ['/configuration/tbl-config-mapping/create', 'id' => $model->union_code], ['class' => 'btn btn-danger btn-block']);
?>
