...
$this->params['menu'][] = GhostHtml::a('<i class="fa fa fa fa-money-bill-bill"></i>' . Yii::t('app', 'Payment Configurations'), ['/configuration/tbl-config-mapping/index', 'id' => $model->union_code], ['class' => 'btn btn-danger btn-block']);
?>
