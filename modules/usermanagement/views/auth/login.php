                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="login-content text-center">
                                        ...
                                        <a href="javascript:void(0)" class="btn-login  btn btn-danger btn-login" data-bs-toggle="modal" data-bs-target="#loginModal"><i class="fas fa-sign-in-alt"></i> Login</a><br>
                                        <div class="col-xs-12 d-contents">
