...
<div class="navbar fixed-top menu-wrap">
    <div class="container-fluid">
        <a class="navbar-brand" href="javascript:void(0)">
            <img src="<?= $this->theme->getUrl('/assets/kotmale/images/logo.png') ?>" alt="AMCS Logo" class="logo img-responsive" />
        </a>
    </div>
</div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="login-content text-justify">
                                        <?php $image_path = Yii::$app->request->baseUrl . '/themes/emilk/assets/kotmale/images/'; ?>
                                        <div class="col-sm-12">
                                        ...
                                        <a href="javascript:void(0)" class="btn-login  btn btn-danger" data-bs-toggle="modal" data-bs-target="#loginModal"><i class="fas fa-sign-in-alt"></i> Login</a><br>
