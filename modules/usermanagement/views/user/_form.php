...
//                ->dropDownList(User::getStatusList())
    ...
    <?php endif; ?>
    <div class="col-sm-2">
        <?= Yii::$app->dropdown->dropdownStatic('login_type', $model, $form, '', 'Login Type', false, 'login_type'); ?>
        <?php //Yii::$app->dropdown->dropdownStatic('user_login_type', $model, $form, '', 'Login Type', FALSE, 'login_type', FALSE, TRUE) ?> 
    </div>
