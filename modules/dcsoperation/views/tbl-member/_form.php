...
<div class="row theme_border_left theme_border_right theme_border_bottom">
    ...
    <div class="col-md-6 padding_10_0 theme-box ">
        ...
        <div class="col-sm-4">
            <?php Yii::$app->dropdown->depend_dropdown('sub_district_code', $model, $form, 'tblmember-district_code', 'form-group col-sm-4 padding-right-5 padding-left-0', 'Sub District'); ?>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-4">
            <?php Yii::$app->dropdown->depend_dropdown('village_code', $model, $form, 'tblmember-sub_district_code', 'form-group col-sm-4 padding-right-5 padding-left-0', 'Village'); ?>
        </div>

        <div class="col-sm-4">
            <?php Yii::$app->dropdown->depend_dropdown('hamlet_code', $model, $form, 'tblmember-village_code', 'form-group col-sm-4 padding-right-5 padding-left-0', 'Hamlet'); ?>
        </div>
        <div class="col-sm-4">
