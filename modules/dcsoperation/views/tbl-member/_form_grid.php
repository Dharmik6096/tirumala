...
//        },
        ...
        'document-upload' => function ($url, $model) {
            ...
            $options = ['data-bs-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Document Upload', 'class' => '' . $class, 'data-val' => $model->member_code, 'data-name' => $name];
...
Yii::$app->grid->bind($dataProvider, $searchModel, $grid_option, ['index'], true, [IOFactory::WRITER_CSV, IOFactory::WRITER_XLSX]);
?>
