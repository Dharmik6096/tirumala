    ...
    $attribute = [
        ['class' => 'kartik\grid\CheckboxColumn',
            ...
            'checkboxOptions' => function($model) {
                ...
                return ['class' => 'checkbox-collection', 'value' => $model['dcs_code'], 'disabled' => $disabled];
            }],
        ...
        ['attribute' => 'sap_route_code', 'filter' => false, 'value' => function($model) {
                return Yii::$app->general->getforeignkey($model->routeMapping, 'sap_route_code');
            }, 'filter' => false],
        ['attribute' => 'sap_vendor_code', 'label' => Yii::t('app', 'Sap Plant Code'), 'filter' => false, 'value' => function($model) {
                return Yii::$app->general->getforeignkey($model->plantCode, 'sap_vendor_code');
            }, 'filter' => false],
        ['attribute' => 'mobile_no', 'filter' => false],
        ['attribute' => 'ref_code', 'label' => Yii::t('app', 'BMC Ref Code'), 'filter' => false, 'value' => function($model) {
                return Yii::$app->general->getforeignkey($model->bmcCode, 'ref_code');
            }, 'filter' => false],
        ['attribute' => 'ref_code', 'label' => Yii::t('app', 'Route Ref Code'), 'filter' => false, 'value' => function($model) {
    ...
    $("#bipl-repush-bulk").click(function() {
        var len = $("input[class=\"checkbox-collection kv-row-checkbox\"]:checked").length;
            ...
            $.ajax({
                ...
                data: {selection: $("input[class=\"checkbox-collection kv-row-checkbox\"]:checked").map(function() { return this.value; }).get(), type:"dcs"},
      ...
      ';
$this->registerJs($script, View::POS_END, 'bipl-repush-bulk');
