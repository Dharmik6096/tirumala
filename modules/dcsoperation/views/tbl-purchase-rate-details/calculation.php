...
<div class="table-responsive">
    <table class="table table-bordered table-hover table-language table-rate">
        ...
        <?php } else { ?>
            <thead>
                <tr>
                    <th>FAT/SNF</th>
                    <?php for ($i = $_POST['TblPurchaseRateAuto']['snf']; $i <= $_POST['TblPurchaseRateAuto']['snf_to']; $i+=0.10) { ?>
                        <th><?= $i ?></th>
                        <?php } ?>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($modelAtteributes as $key => $attr) { ?>
                    <tr>
                        ...
                        <?php
                        $snf = 0;
                        for ($i = $_POST['TblPurchaseRateAuto']['snf']; $i <= $_POST['TblPurchaseRateAuto']['snf_to']; $i+=0.10) {
                            ?>
