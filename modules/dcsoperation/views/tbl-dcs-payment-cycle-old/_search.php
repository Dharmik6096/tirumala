...
<?= Yii::$app->dropdown->union($model, $form, 'tbldcspaymentcyclesearch-federation_code', 'union_code', false); ?>
    </div>
    <div class="col-sm-2 padding-left-0 padding-right-5">
        <?= Yii::$app->dropdown->depend_dropdown('dcs', $model, $form, 'tbldcspaymentcyclesearch-union_code'); ?>
    </div>
