...
<div class="tbl-sub-center-search">
    ...
    <?= Yii::$app->dropdown->union($model, $form, 'tblheadloadsearch-federation_code', 'union_code', false); ?>
    </div>
    <div class="col-sm-2 padding-left-0 padding-right-5">
        <?= Yii::$app->dropdown->depend_dropdown('dcs', $model, $form, 'tblheadloadsearch-union_code'); ?>
    </div>
