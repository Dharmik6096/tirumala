...
<div class="panel panel-default panel-grid panel-main">
    <div class="panel-heading">
        <?= Yii::$app->controls->cancel($model, 'tbl-dcs-purchase-rate/index'); ?>
        <?= $this->title ?>
    </div>
...
<?php
$script = "
    $('#tbldcspurchaseratedetails-milk_type_code').on('change', function(e){
    this.form.submit()
  });
    $('#tbldcspurchaseratedetails-milk_quality_type_code').on('change', function(e){
    this.form.submit()
  });
