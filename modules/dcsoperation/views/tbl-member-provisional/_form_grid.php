...
$grid_option = [
    ...
    'actions' => [
        ...
        //     $name = $model->member_name;
        //     $class = ($model->is_active == 1) ? '' : 'link-disable';
        //     $options = ['data-toggle' => 'tooltip', 'data-placement' => 'top', 'data-original-title' => 'Deactivate', 'class' => 'deact-member ' . $class, 'data-val' => $model->provisional_member_code, 'data-name' => $name];
        //     return GhostHtml::a_alert('<i class="fa fa-close"></i>', ['/dcsoperation/tbl-member-provisional/deactivate-user'], $options);
        // },
        // //'delete' => ['option' => 'member_name,provisional_member_code,tbl-member/delete'],
        // 'block-unblock' => function ($url, $model) {
        //     $name = $model->member_name;
        //     $class = '';
        //     $options = ['data-toggle' => 'tooltip', 'data-placement' => 'top', 'data-original-title' => 'Mobile App Info', 'class' => 'block-unblock ' . $class, 'data-val' => $model->provisional_member_code, 'data-name' => $name];
        //     return GhostHtml::a_alert('<i class="fa fa-mobile"></i>', ['/dcsoperation/tbl-member-provisional/block-unblock'], $options);
        // },
    ]
];
...
$(document).ready(function(){
    ...
    $(document).on('click','.block-unblock',function(e){
        $('#pageloader').show();
        $('#loadercontent').show();
        var provisional_member_code= $(this).attr('data-val');
        $.ajax({
            type: 'post',
            url: '" . Url::to(['/dcsoperation/tbl-member/app-information']) . "',
            data:{'provisional_member_code':provisional_member_code},
            success: function(data) {     
