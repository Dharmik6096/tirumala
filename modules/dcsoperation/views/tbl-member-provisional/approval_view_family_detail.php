...
$this->title = 'Member Approval View - Family Details';
?>
...
<div class="panel panel-default panel-main">
    <div class="panel-body">
            ...
            <div class="col-md-12 view-subtitle padding_10_0 theme-box ">
                ...
                <div class="col-sm-12">
                    ...
                    $this->render('_family_grid', [
                        'familyMemberModel' => $memberFamilySearchModel,
                        'fDataProvider' => $memberFamilyDataProvider,
                    ])
                    ?>
                </div>
            </div>
        ...
        $previews .= '<div class="doc-preview-card"><span class="doc-preview-header">' . Yii::t('app', 'Nominee Address Back Proof') . '</span>' . (trim($nAddressProofback) != '' ? $nAddressProofback : '<div class="no-attachment">' . Yii::t('app', 'No Attachment') . '</div>') . '</div>';
        ?>
