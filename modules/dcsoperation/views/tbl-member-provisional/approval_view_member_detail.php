        ...
        <div class="row theme_border_left theme_border_right theme_border_bottom">
            <div class="col-md-12 padding_10_0">
                ...
                <div class="col-sm-4 text-center">
                    <?= Yii::t('app', 'Member Photo :') ?><br>
                    <?= Yii::$app->general->getDisplayDocumentLink($model->provisional_member_code, 'tbl_member_provisional', ['member_photo'], 'image') ?>
                </div>
                <div class="col-sm-4 text-center">
                    <?= Yii::t('app', 'Signature Photo :') ?><br>
                    <?= Yii::$app->general->getDisplayDocumentLink($model->provisional_member_code, 'tbl_member_provisional', ['signature_photo'], 'image') ?>
                </div>
            </div>
        </div>
