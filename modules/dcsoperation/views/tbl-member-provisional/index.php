...
$this->params['menu'][] = Yii::$app->controls->custombutton('<i class="fa fa-check"></i> ' . Yii::t('app', 'Provisional Member Approvals'), ['/dcsoperation/tbl-member-provisional/provisional-members-approvals'], true);
?>
