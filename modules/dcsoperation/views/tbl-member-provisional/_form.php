...
<div class="row theme_border_left theme_border_right theme_border_bottom">
    <div class="col-md-6 padding_10_0 theme_border_right">
        ...
        <div class="col-sm-4">
            <?php $readonly = (empty($model->provisional_status) || (($model->provisional_status == 'Pending' || $model->provisional_status == 'Re-route') && $model->provisional_from != 'mobile_update')) ? false : true; ?>
