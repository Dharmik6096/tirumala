    ...
    <div class="col-sm-12 margin-top-10 shortcut-main" shortcut="true" display_shortcut="false" hilight_shortcut="false">
        <div class="form-group">
            ...
            if ($configValue == 1) {
                ...
                if ($type == 'edit') {
                    echo Html::submitButton(Yii::t('app', 'Update'), ['class' => 'btn btn-primary apply-shortcut', 'name' => 'submitBtn', 'value' => 'save']);
                    echo Html::submitButton(Yii::t('app', 'Update & Approve'), ['class' => 'btn btn-primary apply-shortcut', 'name' => 'submitBtn', 'value' => 'approve']);
                } else {
