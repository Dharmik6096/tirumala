...
use app\modules\dcsoperation\models\TblDcsPaymentCycleSearch;
 ...
 */
class TblDcsPaymentCycleController extends \app\controllers\ChildController
{
    ...
    /**
     * Displays a single TblDcsPaymentCycle model.
     * @param string $id
     * @return mixed
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->dcs_payment_cycle_code]);
        } else {
