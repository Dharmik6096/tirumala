...
/**
 * This is the model class for table "tbl_purchase_rate_applicability_alias_history".
 *
 * @property integer $id
 ...
 */
class TblPurchaseRateApplicabilityAliasHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_purchase_rate_applicability_alias_history';
    }
    ...
    public function rules() {
        return [
            ...
            [['wef_date', 'download_date_time', 'created_at', 'updated_at', 'history_created_at', 'status', 'shift_applicability'], 'safe'],
