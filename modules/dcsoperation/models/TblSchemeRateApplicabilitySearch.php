...
class TblSchemeRateApplicabilitySearch extends TblSchemeRateApplicability {
    ...
    public function rules() {
        return [
                ...
                [['scheme_rate_code', 'from_date', 'to_date', 'applicable_for', 'applicable_code', 'union_code', 'rate_class', 'created_at', 'created_by', 'updated_at', 'updated_by', 'originating_org_code', 'originating_org_type', 'x_col1', 'x_col2', 'x_col3', 'x_col4', 'x_col5'], 'safe'],
                [['rtpl'], 'number'],
        ];
    }
