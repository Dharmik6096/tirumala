...
class TblPurchaseRateApplicability extends \app\models\ChildModel {
    ...
    public function rules() {
        return [
            ...
            [['dcs_code'], 'unique', 'targetAttribute' => ['dcs_code', 'wef_date', 'shift_code'], 'message' => Yii::t('app/validation', 'Record Is Already Exist For Member Applicability'), 'on' => ['stellapps', 'importCsv']],
