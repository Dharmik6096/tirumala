...
class TblMemberProvisional extends ChildModel {
    ...
    public function rules() {
        return [
            ...
            [['member_code', 'state_code', 'address', 'union_code', 'no_of_buffalo', 'no_of_cow_cross', 'no_of_cow_ind', 'total_animals', 'gender_code', 'animal_type_code', 'caste_category_code', 'member_type_code',], 'required', 'on' => ['approveMember']],
