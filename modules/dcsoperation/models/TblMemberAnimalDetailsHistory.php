...
/**
 * This is the model class for table "tbl_member_animal_details_history".
 *
 * @property integer $id
 ...
 */
class TblMemberAnimalDetailsHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_member_animal_details_history';
    }
    ...
    public function rules() {
        return [
                [['member_animal_detail_code', 'animal_type_code', 'heifers_count', 'milch_animal_count', 'dry_animal_count', 'total_animal', 'originating_type', 'union_code', 'member_code', 'daily_milk_production', 'created_at', 'created_by', 'operation_type', 'originating_org_code', 'originating_org_type', 'updated_by', 'history_created_by', 'updated_at', 'history_created_at'], 'safe'],
        ];
    }
