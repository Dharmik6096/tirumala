...
class TblMemberProvisionalSearch extends TblMemberProvisional {
    ...
    public $mobile_no, $federation_code, $ifsc, $union_code, $plant_code, $mcc_plant_code, $bmc_code, $approved_status, $from_date, $to_date, $as_on_date;
