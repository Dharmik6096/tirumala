...
class TblMemberProvisionalSearch extends TblMemberProvisional {
    ...
    public function search($params, $pending_approval = false, $date_search = false) {
        ...
        if (!$date_search) {
            ...
            $query->andFilterWhere(['and', ['>=', 'tbl_member_provisional.created_at', date('Y-m-d', strtotime($from_date)) . ' 00:00:00.000'], ['<=', 'tbl_member_provisional.created_at', date('Y-m-d', strtotime($to_date)) . ' 23:59:59.000']]);
        }
