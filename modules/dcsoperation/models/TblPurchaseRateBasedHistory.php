...
/**
 * This is the model class for table "tbl_purchase_rate_based_history".
 *
 * @property integer $id
 ...
 */
class TblPurchaseRateBasedHistory extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_purchase_rate_based_history';
    }
...
//            [['end_range', 'fixed_point', 'kg_rate', 'start_range', 'step', 'value'], 'number'],
    ...
    /**
     * @inheritdoc
     * @return TblPurchaseRateBasedHistoryQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new TblPurchaseRateBasedHistoryQuery(get_called_class());
    }
}
