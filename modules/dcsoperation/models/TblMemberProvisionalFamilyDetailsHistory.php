...
/**
 * This is the model class for table "tbl_member_provisional_family_details_history".
 *
 * @property integer $id
 ...
 */
class TblMemberProvisionalFamilyDetailsHistory extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'tbl_member_provisional_family_details_history';
    }
    ...
    public function rules() {
        return [
                [['union_code', 'provisional_member_code', 'dob', 'remarks', 'family_member_name', 'guardian_name', 'operation_type', 'originating_org_code', 'originating_org_type', 'created_by', 'updated_by', 'history_created_by', 'local_family_member_name', 'nominee_address', 'local_nominee_address', 'local_guardian_name', 'member_provisional_family_detail_code', 'age', 'gender_code', 'relationship_code', 'is_nominee', 'created_at', 'updated_at', 'history_created_at', 'originating_type'], 'safe'],
        ];
    }
