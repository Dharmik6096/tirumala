...
class TblDcsPurchaseRateApplicabititySearch extends TblDcsPurchaseRateApplicabitity {
    ...
    public $mcc_name, $code_ex, $shift_code, $rate_for, $ref_code, $bmc_name;
    ...
    public function rules() {
        return [
            ...
            //   [['is_active'], 'boolean'],
            //   [['shift_code'], 'integer'],
            [['wef_date', 'applicable_for', 'mcc_name', 'applicable_code', 'applicable_for', 'code_ex', 'shift_code', 'plant_code', 'mcc_plant_code', 'bmc_code', 'rate_for', 'union_code', 'dcs_code', 'purchase_rate_code', 'shift_applicability', 'ref_code', 'bmc_name'], 'safe'],
