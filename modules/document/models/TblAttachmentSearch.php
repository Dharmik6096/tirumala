...
class TblAttachmentSearch extends TblAttachment
{
    ...
    public function rules()
    {
        return [
            ...
            [['module_code', 'module_name', 'attachment_type', 'remarks', 'file_name', 'attachment', 'lat_long', 'parent_code', 'device_id', 'thumbnail', 'created_at', 'created_by', 'updated_at', 'updated_by', 'originating_org_code', 'originating_org_type'], 'safe'],
        ];
    }
