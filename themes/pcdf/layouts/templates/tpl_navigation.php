...
//                ['label' => 'Calibration', 'url' => ['/collection/tbl-m-a-c-alibration/index'], 'active' => ($cntrl == 'tbl-ma-calibration')],
                ['label' => 'Cleaning', 'url' => ['/collection/tbl-analyzer-cleaning/index'], 'active' => ($cntrl == 'tbl-ma-cleaning')],
                    ...
                    ['label' => Yii::t('app', 'BMC Shift Lock'), 'url' => ['/collection/tbl-mcc-shift-lock/index'], 'active' => ($cntrl == 'tbl-mcc-shift-lock'), 'visible' => ($eiplCode == 'MMD' && User::canRoute(['/collection/tbl-mcc-shift-lock/index'])) ? TRUE : FALSE],
                    ['label' => Yii::t('app', 'Shift Lock'), 'url' => ['/collection/tbl-mcc-shift-lock/index-other'], 'active' => ($cntrl == 'tbl-mcc-shift-lock' && $action == 'index-other'), 'visible' => ($eiplCode == 'MMD' && User::canRoute(['/collection/tbl-mcc-shift-lock/index-other'])) ? FALSE : TRUE],
...
//                                    ['label' => '110 -' . Yii::t('app', 'New Member Pouring Milk'), 'url' => ['/misreports/reports/new-member-pouring-milk']],
                                ['label' => '110 -' . Yii::t('app', 'Farmer Incentive'), 'url' => ['/jasperreports/default/farmer-incentive']],
                                    ...
                                    ['label' => '113 -' . Yii::t('app', 'VLCs comparison summary'), 'url' => ['/misreports/reports/milk-collection-proc']],
                                    ['label' => '114 -' . Yii::t('app', 'VLCs comparison details'), 'url' => ['/misreports/reports/milk-collection-proc-detail']],
                                    ['label' => '115 -' . Yii::t('app', 'Absent Pouring VLCs'), 'url' => ['/misreports/reports/milk-collection-absent']],
                                    ['label' => '116 -' . Yii::t('app', 'VLC Left Pourers'), 'url' => ['/misreports/reports/left-pourer']],
                                    ['label' => '117 -' . Yii::t('app', 'Negative Growth VLCs'), 'url' => ['/misreports/reports/milk-collection-negative-groth']],
                            ]
                        ],
                            [
                            'options' => ['class' => 'dropdown-submenu'],
                            ...
                            'items' => [
                                    ...
                                    ['label' => '207 -' . Yii::t('app', 'Society Wise CDA Format 1'), 'url' => ['/misreports/reports/society-wise-cda'], 'visible' => (($eiplCode == 'GYAN' || $eiplCode == 'MURALYA') && User::canRoute(['/misreports/reports/society-wise-cda'])) ? FALSE : TRUE],
                                    ['label' => '207 -' . Yii::t('app', 'Society Wise CDA Format 2'), 'url' => ['/misreports/reports/society-wise-cda-format'], 'visible' => (($eiplCode == 'GYAN' || $eiplCode == 'MURALYA') && User::canRoute(['/misreports/reports/society-wise-cda-format'])) ? FALSE : TRUE],
                                    ['label' => '207 -' . Yii::t('app', 'Society Wise Variance'), 'url' => ['/misreports/reports/society-wise-cda-two'], 'visible' => (($eiplCode == 'GYAN' || $eiplCode == 'MURALYA') && User::canRoute(['/misreports/reports/society-wise-cda-two'])) ? TRUE : FALSE],
                                    ...
                                    ['label' => '217 -' . Yii::t('app', 'Society Composite Vs Actual Report'), 'url' => ['/misreports/reports/society-composite-vs-actual'], 'visible' => ($eiplCode == 'MMD' && User::canRoute(['/misreports/reports/society-composite-vs-actual'])) ? TRUE : FALSE],
                    ...
                    'items' => [
                            ...
                            ['label' => '612-' . Yii::t('app', 'Vendor Bill'), 'url' => ['/jasperreports/default/vendor-bill'], 'visible' => ($eiplCode == 'MMD' && User::canRoute(['/jasperreports/default/vendor-bill'])) ? FALSE : TRUE],
                            ['label' => '612-' . Yii::t('app', 'Member and Vendor Milk Bill'), 'url' => ['/jasperreports/default/vendor-bill-mmd'], 'visible' => ($eiplCode == 'MMD' && User::canRoute(['/jasperreports/default/vendor-bill-mmd'])) ? TRUE : FALSE],
                            ...
                            ['label' => '616-' . Yii::t('app', 'Milk Bill'), 'url' => ['/jasperreports/default/vendor-milk-bill-varddan'], 'visible' => ($eiplCode == 'SNMILK' && User::canRoute(['/jasperreports/default/vendor-milk-bill-varddan'])) ? FALSE : TRUE],
                            ['label' => '616-' . Yii::t('app', 'Milk Bill'), 'url' => ['/jasperreports/default/vendor-milk-bill-snmilk'], 'visible' => ($eiplCode == 'SNMILK' && User::canRoute(['/jasperreports/default/vendor-milk-bill-snmilk'])) ? TRUE : FALSE],
...
//                ['label' => 'Set Originating Location', 'url' => ['/user-management/permission/set-originate-action'], 'active' => ($cntrl == 'permission'),],
                    ...
                    'items' => [
                            ...
                            ['label' => Yii::t('app', 'Help Manual'), 'url' => ['/site/help-manual'], 'visible' => ($eiplCode == 'GYAN' && User::canRoute(['/site/help-manual'])) ? TRUE : FALSE],
...
//                        ['label' => Yii::t('app', 'Custom Import (Update)'), 'url' => ['/customimport/default/update-by-import'], 'active' => ($cntrl == 'customimport-update')],
                        ['label' => Yii::t('app', 'DPU Incentive'), 'url' => ['/general/tbl-dpu-incentive-master/index'], 'active' => ($cntrl == 'tbl-dpu-incentive-master')],
                            ...
                            ['label' => Yii::t('app', 'SAP Data Export'), 'url' => ['/misreports/default/sap-report'], 'active' => ($cntrl == 'default' && $action == 'sap-report'), 'visible' => ($eiplCode == 'DODLA' && User::canRoute(['/misreports/default/sap-report'])) ? FALSE : TRUE],
