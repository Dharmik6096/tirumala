...
////                        ['label' => '309-' . Yii::t('app', 'Difference Report'), 'url' => ['/jasperreports/default/difference-report']],
                ...
                [
                    ...
                    'items' => [
                        ['label' => Yii::t('app', '701 - Analyzer Cleaning Review'), 'url' => ['/misreports/default/analyzer-cleaning-review']],
                        ['label' => Yii::t('app', '702 - Analyzer Cleaning Pending Activity'), 'url' => ['/misreports/default/analyzer-cleaning-pending-activity']],
                        ['label' => Yii::t('app', '703 - Analyzer PCB Replacement'), 'url' => ['/misreports/default/analyzer-pcb-replacement']],
                        ['label' => Yii::t('app', '704 - Cleaning Flag Report'), 'url' => ['/misreports/default/cleaning-flag']],
                        ['label' => Yii::t('app', '705 - Eko Milk Calibration'), 'url' => ['/misreports/default/eko-milk-calibration']],
                        ['label' => Yii::t('app', '706 - Calibration Flag'), 'url' => ['/misreports/default/calibration-flag']],
                        ['label' => Yii::t('app', '707 - Cleaning Flag Bmc'), 'url' => ['/misreports/default/cleaning-flag-bmc']],
                    ]
                ],
