...
//                        ['label' => '313-' . Yii::t('app', 'DPU-GPRS Data Reconciliation'), 'url' => ['/jasperreports/default/gprs-data-reconciliation']],
            ...
            'items' => [
                    ...
                    'items' => [
                            ...
                            ['label' => Yii::t('app', 'Stock Dispatch To MCC Report'), 'url' => ['/misreports/reports/stock-dispatch-to-mcc-report']],
                            ['label' => Yii::t('app', 'Stock Received To MCC Report'), 'url' => ['/misreports/reports/stock-received-to-mcc-report']],
                    ]
                ],
                    ['label' => '', 'url' => 'javascript:void(0)', 'visible' => true],
            ],
