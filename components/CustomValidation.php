            ...
            'GYAN' => [
                ...
                'TblMember' => [
                    'default' => [
                            ...
                            ['bank_account_no', 'unique', 'targetAttribute' => ['bank_account_no', 'ifsc', 'is_active', 'dcs_code'], 'message' => \Yii::t('app/validation', '{attribute} has already been taken.'), function ($model) {
