...
class Path extends Component {
    ...
    private $config = [
        ...
        '\\app\modules\syncutility\models\\' => ['TblSentbox', 'TblInbox', 'TblSyncLog', 'TblSentboxClone', 'TblForceSyncRequest', 'TblForceSyncRequestHistory', 'TblForceSyncTableList', 'TblSentboxDesktop', 'TblSentboxDesktopClone'],
        ...
        '\\app\modules\sms\models\\' => ['TblApiMaster', 'TblBulkNotification', 'TblBulkNotificationHistory', 'TblSmsFailLog', 'TblAlertRuleMaster', 'TblAlertRuleMapping', 'TblAlertRuleMappingHistory', 'TblMessage', 'TblMessageHistory'],
