...
class Path extends Component {
    ...
    private $config = [
        ...
        '\\app\modules\product\models\\' =>
            ...
            'TblGrn', 'TblGrnTxn', 'TblPlantDispatch', 'TblPlantDispatchTxn', 'TblIndentMaster', 'TblIndentDispatch', 'TblIndentDispatchTransaction', 'TblIndentProduct', 'TblProductStockPhysical', 'TblProductStockSap', 'TblGrnInstallment', 'TblPlantDispatchTxnHistory', 'TblPlantDispatchHistory', 'TblDispatchCenter', 'TblDispatchCenterType'],
