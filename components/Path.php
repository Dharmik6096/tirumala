...
class Path extends Component {
    ...
    private $config = [
        ...
        '\\app\modules\product\models\\' =>
            ...
            'TblGrn', 'TblGrnTxn', 'TblPlantDispatch', 'TblPlantDispatchTxn', 'TblIndentMaster', 'TblIndentDispatch', 'TblIndentDispatchTransaction', 'TblIndentProduct', 'TblProductStockPhysical', 'TblProductStockPhysicalSearch', 'TblProductStockSap', 'TblProductStockSapSearch'],
