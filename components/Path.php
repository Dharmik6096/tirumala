...
class Path extends Component {
    ...
    private $config = [
        ...
        '\\app\modules\veterinary\models\\' => ['TblMemberAnimalTagDetails', 'TblCaseType', 'TblAnimalTreatmentRequest', 'TblDiagnosisDetails', 'TblMedicineStock', 'TblMedicineStockTransaction', 'TblTreatmentDetails'],
    ];
