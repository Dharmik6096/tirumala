    ...
    public function getRecords($l) {
        $records = [
            ...
            'master_type' => [
                'name' => 'master_type',
                'prompt' => Yii::t('app', 'Select'),
                'data' => ['plant' => Yii::t('app', 'Plant'), 'bmc' => Yii::t('app', 'BMC'), 'dcs' => Yii::t('app', 'DCS'), 'member' => Yii::t('app', 'Member')],
            ],
...
//            'union_trip' => ['name' => 'trip_code', 'fields' => 'trip_code,trip_code,', 'prompt' => Yii::t('app', 'Select Trip'), 'model' => 'TblVehicleTrip', 'depend' => 'union_code', 'dependArray' => ['trip_status']],
            ...
            'hold_reason' => ['name' => 'hold_reason', 'fields' => 'description,hold_reason', 'prompt' => Yii::t('app', 'Select Hold Reason'), 'model' => 'TblPaymentHoldReason'],
        ];
        return $label[$l];
    }
