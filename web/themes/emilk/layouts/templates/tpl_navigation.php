            ...
            'items' => [
                    ...
                    'items' => [
                        ...
                        ['label' => Yii::t('app', 'DPU Incentive'), 'url' => ['/general/tbl-dpu-incentive-master/index'], 'active' => ($cntrl == 'tbl-dpu-incentive-master')],
                            ...
                            ['label' => Yii::t('app', 'SAP Data Export 2'), 'url' => ['/misreports/default/sap-report-export'], 'active' => ($cntrl == 'default' && $action == 'sap-report-export'), 'visible' => User::canRoute(['/misreports/default/sap-report-export']) ? (($eiplCode == 'DODLA') ? FALSE : TRUE) : FALSE],
