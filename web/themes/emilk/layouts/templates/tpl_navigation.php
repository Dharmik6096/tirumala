...
//            'template' => '<a href="#" data-target="#" data-toggle="dropdown" class="dropdown-toggle apply-shortcut" shortcut_key="shift+alt+c" >' . Yii::t('app', 'Milk Collection') . ' <b class="caret"></b></a>',
            ...
            'items' => [
                ...
                ['label' => 'Collection Farmer Local Sale', 'url' => ['/collection/collection-farmer-local-sale/index'], 'active' => ($cntrl == 'collection-farmer-local-sale')],
            ...
            'items' => [
                ...
                [
                    ...
                    'items' => [
                        ...
                        ['label' => Yii::t('app', 'Software Complaint'), 'url' => ['/complaint/tbl-software-complaint/index'], 'active' => ($cntrl == 'tbl-software-complaint')],
