    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body dashboard_controls">
                ...
                <div class="col-sm-3">
                    <?= Yii::$app->dropdown->dropdown('customer_type', $model, $form, 'form-group col-sm-2 padding-right-5 padding-left-0', FALSE, FALSE, 'customer_type'); ?>
                </div>
                <div class="col-sm-3">
...
$script = "
    $(document).ready(function () {
        ...
        function topDcsCollection(){  
            var from_date = $('#top_rmrd_tab_dt1').val();
            var to_date = $('#top_rmrd_tab_dt2').val();
//            var union = $('#dashboard-union_code').val();
            var customer_type = $('#dashboard-customer_type').val();
            var union= '" . $unionCode . "';
            var mcc= '" . $mccCode . "';
            var type= 'rmrd';
            ...
            if(from_date != '' && to_date != ''){
                $.ajax({
                    ...
                    data: {'from_date' : from_date, 'to_date' : to_date, 'union' : union, 'mcc':mcc,'type':type,'customer_type':customer_type,'performance_type':performance_type} ,
