...
$this->title = Yii::t('app', Yii::$app->label->title('list', 'Route Supervisor'));
                                        ...
                                        <table class="table overflow_hidden table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="custom_grid_header"><?= Yii::t('app', 'Master Code') ?></th>
                                                    <th class="custom_grid_header"><?= Yii::t('app', 'User Name') ?></th>
                                                    <th class="custom_grid_header"><?= Yii::t('app', 'Login Type') ?></th>
                                                    <th class="custom_grid_header"><?= Yii::t('app', 'Mobile NO') ?></th>
                                                    <th class="custom_grid_header"><?= Yii::t('app', 'Otp Code') ?></th>
                                                    <th class="custom_grid_header"><?= Yii::t('app', 'Status') ?></th>
                                                    <th class="custom_grid_header"><?= Yii::t('app', 'Expired Datetime') ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                if (!empty($output)) {
                                                    ...
                                                    foreach ($output as $data) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php
                                                            $tbl_Eipl_model = new TblEiplAppLogin();
                                                            $tbl_Eipl_model->master_code = $data['master_code'];
                                                            ?>
                                                            <td class="grid_left_align custom_grid_normal"><?= $data['master_code'] ?></td>
                                                            <td class="grid_left_align custom_grid_normal"><?= $data['user_name'] ?></td>
                                                            <td class="grid_left_align custom_grid_normal"><?= $data['login_type'] ?></td>
                                                            <td class="grid_left_align custom_grid_normal"><?= $data['mobile_no'] ?></td>
                                                            <td class="grid_left_align custom_grid_normal"><?= $data['otp_code'] ?></td>
                                                            <td class="grid_left_align custom_grid_normal"><?= $data['is_active'] ?></td>
                                                            <td class="grid_left_align custom_grid_normal"><?= $data['expired_datetime'] ?></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                } else {
