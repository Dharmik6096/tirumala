...
$category_type = ['1' => 'Total', '2' => 'Avg per Trip'];
...
$id1 = !empty($range_id1) ? $range_id1 : 'cc_plant_dt1';
$id2 = !empty($range_id2) ? $range_id2 : 'cc_plant_dt2';
            ...
            <div class="modal-body dashboard_controls">
                ...
                <div class="col-sm-3">
                    <?= Select2::widget([
                            ...
                            'data' => $category_type,
                            'value' => '1',
                            'options' => ['id' => 'cc-plant-wise-tanker-qty-status-detail-' . $id],
                    ]); ?>
                </div>
...
$script = "
    $(document).ready(function () {
        setCcPlantWiseTankerQtyStatusDetailTab(); 
        ...
        function setCcPlantWiseTankerQtyStatusDetailTab(){  
            var from_date = $('#$id1').val();
            var to_date = $('#$id2').val();
            var union = '" . $unionCode . "';
            var h_type = $('#cc-plant-wise-tanker-qty-status-detail-$id').val(); 
             
            if(from_date != '' && to_date != ''){
                $.ajax({
                    type: 'post',
                    url:'" . Url::to(['cc-plant-wise-tanker-qty-status-detail-tab']) . "',
                    data: {
                        'from_date' : from_date, 
                        'to_date' : to_date, 
                        'union' : union,
