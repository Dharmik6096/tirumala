...
<div class="col-sm-12">
    <div class="cal-header dashboardWidgetHeader col-sm-12"><?= Yii::t('app', 'Qty today'); ?>
        ...
        <div class="modal-dialog PlantWiseTankerMilkDetailModal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="PlantWiseTankerMilkDetailModalLabel"><?= Yii::t('app', 'Qty today'); ?></h5>
