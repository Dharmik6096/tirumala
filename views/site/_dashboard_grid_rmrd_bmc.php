...
$mcc_url = Url::to(['site/get-rmrd-mccs', 'date' => $date, 'union_code' => $union, 'widget_for' => 'rmrd']);
?>
                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="col-sm-12 padding_left_0 padding_right_0 border_bottom_1">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <?php $url = Url::to(['site/get-rmrd-dcs', 'date' => $date, 'union_code' => $union, 'mcc_code' => $mcc, 'bmc_code' => $data['bmc_code'], 'widget_for' => 'rmrd', 'shift' => $shift]); ?>
