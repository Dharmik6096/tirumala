<div class="col-sm-6">
    <div class="col-sm-12 text-center society-datewise active dashboard_widget_heading dashboardWidgetHeader"><?= Yii::t('app', 'Society Milk Collection - Date Wise'); ?></div>
    <div class="flt">
