...
<!-- <button type="button" class="headerIcon gread_header_icon btn btn-danger apply-shortcut btn-block" data-bs-toggle="collapse" data-bs-target="#dash_collapse_grid"><i class="fa fa-list"></i></button> -->
