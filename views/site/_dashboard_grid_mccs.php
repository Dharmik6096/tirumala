                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="col-sm-12 padding_left_0 padding_right_0 border_bottom_1">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <?php
                                                            if (\Yii::$app->session->get('hasBMC') == 1) {
                                                                $url = Url::to(['site/get-bmcs', 'date' => $date, 'union_code' => $union, 'mcc_code' => $data['mcc_code'], 'shift' => $shift]);
                                                                ?>
                                                            ...
                                                            <?php }
                                                            ?>
                                                            <?php $url = Url::to(['site/get-dcs', 'date' => $date, 'union_code' => $union, 'mcc_code' => $data['mcc_code'], 'shift' => $shift]); ?>
                                                            ...
                                                            <div class="<?= $col_class ?> dash_grid_block_desc text-center href_link_underline"><a href="<?= $url; ?>" ><span class="dash_grid_block_desc_title"><span><?= $data['total_farmers'] ?></span></span></a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
