                                ...
                                ?>
                                    <div class="div_grid_block padding_left_0 padding_right_0 padding_top_0 dashboardWidgetDetailPortion col-sm-3">
                                        <div class="div_grid_block_content">
                                            ...
                                            <h4 class="dash_grid_block_header"><?= !empty(Yii::$app->general->getforeignkey($tbl_dcs_model->tblDcs, 'dcs_name')) ? Yii::$app->general->getforeignkey($tbl_dcs_model->tblDcs, 'dcs_name') : 'N/A'?></h4>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-12 padding_left_0 padding_right_0 border_bottom_1">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <div class="col-sm-12 dash_grid_block_desc text-center "><a href="<?= $url; ?>" ><span class="dash_grid_block_desc_title"><span><?= $data['total_farmers'] ?></span></span></a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        foreach ($output as $data) { 
                                            ...
                                            <tr>
                                                ...
                                                <?php 
                                                    ...
                                                    $tbl_dcs_model->dcs_code = $data['dcs_code'];
                                                ?>
                                                <td class="grid_left_align"><?= !empty(Yii::$app->general->getforeignkey($tbl_dcs_model->tblDcs, 'dcs_name')) ? Yii::$app->general->getforeignkey($tbl_dcs_model->tblDcs, 'dcs_name') : 'N/A' ?></td>
                                                <?php $url = Url::to(['site/get-farmers', 'date' => $date, 'union_code' => $union, 'mcc_code' => $mcc, 'bmc_code' => $bmc, 'dcs_code' => $data['dcs_code']]);?>
