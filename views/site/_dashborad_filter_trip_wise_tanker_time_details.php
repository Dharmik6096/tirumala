...
$category_type = ['1' => 'Total Hours', '2' => 'Avg Per Trip H'];
            ...
            <div class="modal-body dashboard_controls">
                ...
                <div class="col-sm-3">
                    <?= Select2::widget([
                            ...
                            'data' => $category_type,
                            'value' => '1',
                            'options' => ['id' => 'trip-wise-tanker-time-details-' . $id],
                    ]); ?>
                </div>
...
$script = "
    $(document).ready(function () {
        setTripWiseTankerTimeDetailsTab(); 
        ...
        function setTripWiseTankerTimeDetailsTab(){  
            var from_date = $('#$id1').val();
            var to_date = $('#$id2').val();
            var union = '" . $unionCode . "';
            var h_type = $('#trip-wise-tanker-time-details-$id').val(); 
             
            if(from_date != '' && to_date != ''){
                $.ajax({
                    type: 'post',
                    url:'" . Url::to(['trip-wise-tanker-time-details-tab']) . "',
                    data: {
                        'from_date' : from_date, 
                        'to_date' : to_date, 
                        'union' : union,
