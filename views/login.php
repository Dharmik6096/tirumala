    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'PCDF Application') ?></h4>
            </div>
                ...
                <div class="row">
                    ...
                    <div id="org" class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-6" style="display: <?= $org ?>" id="orgnization">
                                <?php
                                echo $form->field($model, 'organization')->widget(DepDrop::classname(), [
                                    'data' => [$model->organization => $model->organization], //[ $model->tenament_id => !($model->isNewRecord)?$model->tenament->tenament_no:''],
                                    'name' => 'organization',
                                    'pluginOptions' => [
                                        'depends' => ['loginform-type'],
                                        'placeholder' => 'Select Organization',
                                        'url' => Url::to(['/site/get-organization']),
                                        'initialize' => true
                                    ]
                                ]);
                                ?>
...
$script = "
     $('#loginform-type').on('change',function(){
        if($('#loginform-type').val()=='PCDF')
        {
            $('#orgnization').css('display','none');
        }else{
        $('#orgnization').css('display','block');
        }
    });
";
